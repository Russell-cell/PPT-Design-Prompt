# PPT-image Design System Inspired by Airbnb

This file adapts the original web/UI-focused design system into a presentation-image system for slides.
Use it to generate cover art, chapter dividers, concept visuals, comparison plates, system diagrams, data backdrops, and closing posters that still feel unmistakably Airbnb.

Source reference: `source/airbnb/DESIGN.md`
Adaptation date: `2026-04-22`

## 1. Visual Theme & Atmosphere

This PPT-image adaptation keeps Airbnb's brand DNA intact, but compresses it into slide-ready visuals instead of webpage UI.
The first priority is to preserve the original atmosphere: Airbnb's 2026 design feels like a travel magazine that happens to be an app — pristine white canvases give way to full-bleed photography, and the interface itself disappears so the listings can breathe.
...
- Preserve the brand's strongest cues: Rausch coral-pink (#ff385c) as a single-accent brand color, used only for primary CTAs and the search button, Full-bleed photography at 4:3 / 16:9 with gentle corner rounding (14–20px) as the primary visual vocabulary, 3D rendered category icons paired with typographic tabs — the one place the system allows illustration, and Circular 50% icon buttons (back arrow, share, favorite, carousel arrows) scattered throughout.
- Use Rausch (#ff385c) as the highest-signal accent when color needs to carry emphasis.
- Let Canvas White (#ffffff) carry calmer title-safe zones and quieter data-support slides.
- Use Ink Black (#222222) for cinematic divider slides, closing posters, or contrast-heavy cover moments.
...
- Base canvas: prefer Canvas White (#ffffff) when the deck needs editorial calm or readable overlay copy.
- Bold contrast canvas: prefer Ink Black (#222222) when the deck needs cinematic weight or a chapter reset.
- Primary accent: Rausch (#ff385c) should carry the strongest callout, hero focal area, or high-signal data accent.
...
- Use Airbnb's strongest visual cues as one large, unmistakable scene or object.
- Let Rausch (#ff385c), Canvas White (#ffffff), and Ink Black (#222222) establish the hierarchy before adding any text.
...
- Translate abstract ideas into one visual metaphor that still feels native to Airbnb.
...
- Let the palette do part of the comparison work: Canvas White (#ffffff) versus Ink Black (#222222), with Rausch (#ff385c) reserved for the decisive signal.
...
- Brand mood: Airbnb's 2026 design feels like a travel magazine that happens to be an app — pristine white canvases give way to full-bleed photography, and the interface itself disappears so the listings can breathe.
- Display voice: `System Sans`
- Body / label voice: `System Sans`
- Primary accent: Rausch (#ff385c)
- Light surface anchor: Canvas White (#ffffff)
- Dark surface anchor: Ink Black (#222222)
- Signature cues: Rausch coral-pink (#ff385c) as a single-accent brand color, used only for primary CTAs and the search button, Full-bleed photography at 4:3 / 16:9 with gentle corner rounding (14–20px) as the primary visual vocabulary, 3D rendered category icons paired with typographic tabs — the one place the system allows illustration, and Circular 50% icon buttons (back arrow, share, favorite, carousel arrows) scattered throughout
...
```text
Create a presentation cover image for a presentation inspired by Airbnb.
Brand mood: Airbnb's 2026 design feels like a travel magazine that happens to be an app — pristine white canvases give way to full-bleed photography, and the interface itself disappears so the listings can breathe.
Use System Sans as the display-type reference and System Sans for any short in-image labels.
Keep the palette anchored in Canvas White (#ffffff), Ink Black (#222222), and Rausch (#ff385c).
Preserve these signature cues: Rausch coral-pink (#ff385c) as a single-accent brand color, used only for primary CTAs and the search button, Full-bleed photography at 4:3 / 16:9 with gentle corner rounding (14–20px) as the primary visual vocabulary, and 3D rendered category icons paired with typographic tabs — the one place the system allows illustration.
...
```text
Create a section divider image for a presentation inspired by Airbnb.
Brand mood: Airbnb's 2026 design feels like a travel magazine that happens to be an app — pristine white canvases give way to full-bleed photography, and the interface itself disappears so the listings can breathe.
Use System Sans as the display-type reference and System Sans for any short in-image labels.
Keep the palette anchored in Canvas White (#ffffff), Ink Black (#222222), and Rausch (#ff385c).
Preserve these signature cues: Rausch coral-pink (#ff385c) as a single-accent brand color, used only for primary CTAs and the search button, Full-bleed photography at 4:3 / 16:9 with gentle corner rounding (14–20px) as the primary visual vocabulary, and 3D rendered category icons paired with typographic tabs — the one place the system allows illustration.
...
```text
Create a concept visualization image for a presentation inspired by Airbnb.
Brand mood: Airbnb's 2026 design feels like a travel magazine that happens to be an app — pristine white canvases give way to full-bleed photography, and the interface itself disappears so the listings can breathe.
Use System Sans as the display-type reference and System Sans for any short in-image labels.
Keep the palette anchored in Canvas White (#ffffff), Ink Black (#222222), and Rausch (#ff385c).
Preserve these signature cues: Rausch coral-pink (#ff385c) as a single-accent brand color, used only for primary CTAs and the search button, Full-bleed photography at 4:3 / 16:9 with gentle corner rounding (14–20px) as the primary visual vocabulary, and 3D rendered category icons paired with typographic tabs — the one place the system allows illustration.
...
```text
Create a comparison image for a presentation inspired by Airbnb.
Brand mood: Airbnb's 2026 design feels like a travel magazine that happens to be an app — pristine white canvases give way to full-bleed photography, and the interface itself disappears so the listings can breathe.
Use System Sans as the display-type reference and System Sans for any short in-image labels.
Keep the palette anchored in Canvas White (#ffffff), Ink Black (#222222), and Rausch (#ff385c).
Preserve these signature cues: Rausch coral-pink (#ff385c) as a single-accent brand color, used only for primary CTAs and the search button, Full-bleed photography at 4:3 / 16:9 with gentle corner rounding (14–20px) as the primary visual vocabulary, and 3D rendered category icons paired with typographic tabs — the one place the system allows illustration.
...
```text
Create a data-support backdrop image for a presentation inspired by Airbnb.
Brand mood: Airbnb's 2026 design feels like a travel magazine that happens to be an app — pristine white canvases give way to full-bleed photography, and the interface itself disappears so the listings can breathe.
Use System Sans as the display-type reference and System Sans for any short in-image labels.
Keep the palette anchored in Canvas White (#ffffff), Ink Black (#222222), and Rausch (#ff385c).
Preserve these signature cues: Rausch coral-pink (#ff385c) as a single-accent brand color, used only for primary CTAs and the search button, Full-bleed photography at 4:3 / 16:9 with gentle corner rounding (14–20px) as the primary visual vocabulary, and 3D rendered category icons paired with typographic tabs — the one place the system allows illustration.
...
```text
Create a closing poster image for a presentation inspired by Airbnb.
Brand mood: Airbnb's 2026 design feels like a travel magazine that happens to be an app — pristine white canvases give way to full-bleed photography, and the interface itself disappears so the listings can breathe.
Use System Sans as the display-type reference and System Sans for any short in-image labels.
Keep the palette anchored in Canvas White (#ffffff), Ink Black (#222222), and Rausch (#ff385c).
Preserve these signature cues: Rausch coral-pink (#ff385c) as a single-accent brand color, used only for primary CTAs and the search button, Full-bleed photography at 4:3 / 16:9 with gentle corner rounding (14–20px) as the primary visual vocabulary, and 3D rendered category icons paired with typographic tabs — the one place the system allows illustration.
