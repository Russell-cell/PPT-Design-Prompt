# PPT-image Design System Inspired by ClickHouse

This file adapts the original web/UI-focused design system into a presentation-image system for slides.
Use it to generate cover art, chapter dividers, concept visuals, comparison plates, system diagrams, data backdrops, and closing posters that still feel unmistakably ClickHouse.

Source reference: `source/clickhouse/DESIGN.md`
Adaptation date: `2026-04-22`

## 1. Visual Theme & Atmosphere

This PPT-image adaptation keeps ClickHouse's brand DNA intact, but compresses it into slide-ready visuals instead of webpage UI.
The first priority is to preserve the original atmosphere: ClickHouse's interface is a high-performance cockpit rendered in acid yellow-green on obsidian black — a design that screams "speed" before you read a single word.
...
- Preserve the brand's strongest cues: Pure black canvas (#000000) with neon yellow-green (#faff69) accent — maximum contrast, Extra-heavy display typography: Inter at weight 900 (Black) up to 96px, Dark charcoal card system with #414141 borders at 80% opacity, and Forest green (#166534) secondary CTA buttons.
- Use Neon Volt (#faff69) as the highest-signal accent when color needs to carry emphasis.
- Let Neon Volt (#faff69) carry calmer title-safe zones and quieter data-support slides.
- Use Near Black (#141414) for cinematic divider slides, closing posters, or contrast-heavy cover moments.
...
- Base canvas: prefer Neon Volt (#faff69) when the deck needs editorial calm or readable overlay copy.
- Bold contrast canvas: prefer Near Black (#141414) when the deck needs cinematic weight or a chapter reset.
- Primary accent: Neon Volt (#faff69) should carry the strongest callout, hero focal area, or high-signal data accent.
...
- Use `Basier (__basier_a58b65), with fallbacks: Arial, Helvetica` as the reference voice for cover words, chapter titles, or one-line in-image headlines when baked text is necessary.
- Use `Basier (__basier_a58b65), with fallbacks: Arial, Helvetica` for labels, short annotations, numerals, or tiny UI-like callouts inside the art.
...
- Use ClickHouse's strongest visual cues as one large, unmistakable scene or object.
- Let Neon Volt (#faff69), Neon Volt (#faff69), and Near Black (#141414) establish the hierarchy before adding any text.
...
- Translate abstract ideas into one visual metaphor that still feels native to ClickHouse.
...
- Let the palette do part of the comparison work: Neon Volt (#faff69) versus Near Black (#141414), with Neon Volt (#faff69) reserved for the decisive signal.
...
- Brand mood: ClickHouse's interface is a high-performance cockpit rendered in acid yellow-green on obsidian black — a design that screams "speed" before you read a single word.
- Display voice: `Basier (__basier_a58b65), with fallbacks: Arial, Helvetica`
- Body / label voice: `Basier (__basier_a58b65), with fallbacks: Arial, Helvetica`
- Primary accent: Neon Volt (#faff69)
- Light surface anchor: Neon Volt (#faff69)
- Dark surface anchor: Near Black (#141414)
- Signature cues: Pure black canvas (#000000) with neon yellow-green (#faff69) accent — maximum contrast, Extra-heavy display typography: Inter at weight 900 (Black) up to 96px, Dark charcoal card system with #414141 borders at 80% opacity, and Forest green (#166534) secondary CTA buttons
...
```text
Create a presentation cover image for a presentation inspired by ClickHouse.
Brand mood: ClickHouse's interface is a high-performance cockpit rendered in acid yellow-green on obsidian black — a design that screams "speed" before you read a single word.
Use Basier (__basier_a58b65), with fallbacks: Arial, Helvetica as the display-type reference and Basier (__basier_a58b65), with fallbacks: Arial, Helvetica for any short in-image labels.
Keep the palette anchored in Neon Volt (#faff69), Near Black (#141414), and Neon Volt (#faff69).
Preserve these signature cues: Pure black canvas (#000000) with neon yellow-green (#faff69) accent — maximum contrast, Extra-heavy display typography: Inter at weight 900 (Black) up to 96px, and Dark charcoal card system with #414141 borders at 80% opacity.
...
```text
Create a section divider image for a presentation inspired by ClickHouse.
Brand mood: ClickHouse's interface is a high-performance cockpit rendered in acid yellow-green on obsidian black — a design that screams "speed" before you read a single word.
Use Basier (__basier_a58b65), with fallbacks: Arial, Helvetica as the display-type reference and Basier (__basier_a58b65), with fallbacks: Arial, Helvetica for any short in-image labels.
Keep the palette anchored in Neon Volt (#faff69), Near Black (#141414), and Neon Volt (#faff69).
Preserve these signature cues: Pure black canvas (#000000) with neon yellow-green (#faff69) accent — maximum contrast, Extra-heavy display typography: Inter at weight 900 (Black) up to 96px, and Dark charcoal card system with #414141 borders at 80% opacity.
...
```text
Create a concept visualization image for a presentation inspired by ClickHouse.
Brand mood: ClickHouse's interface is a high-performance cockpit rendered in acid yellow-green on obsidian black — a design that screams "speed" before you read a single word.
Use Basier (__basier_a58b65), with fallbacks: Arial, Helvetica as the display-type reference and Basier (__basier_a58b65), with fallbacks: Arial, Helvetica for any short in-image labels.
Keep the palette anchored in Neon Volt (#faff69), Near Black (#141414), and Neon Volt (#faff69).
Preserve these signature cues: Pure black canvas (#000000) with neon yellow-green (#faff69) accent — maximum contrast, Extra-heavy display typography: Inter at weight 900 (Black) up to 96px, and Dark charcoal card system with #414141 borders at 80% opacity.
...
```text
Create a comparison image for a presentation inspired by ClickHouse.
Brand mood: ClickHouse's interface is a high-performance cockpit rendered in acid yellow-green on obsidian black — a design that screams "speed" before you read a single word.
Use Basier (__basier_a58b65), with fallbacks: Arial, Helvetica as the display-type reference and Basier (__basier_a58b65), with fallbacks: Arial, Helvetica for any short in-image labels.
Keep the palette anchored in Neon Volt (#faff69), Near Black (#141414), and Neon Volt (#faff69).
Preserve these signature cues: Pure black canvas (#000000) with neon yellow-green (#faff69) accent — maximum contrast, Extra-heavy display typography: Inter at weight 900 (Black) up to 96px, and Dark charcoal card system with #414141 borders at 80% opacity.
...
```text
Create a data-support backdrop image for a presentation inspired by ClickHouse.
Brand mood: ClickHouse's interface is a high-performance cockpit rendered in acid yellow-green on obsidian black — a design that screams "speed" before you read a single word.
Use Basier (__basier_a58b65), with fallbacks: Arial, Helvetica as the display-type reference and Basier (__basier_a58b65), with fallbacks: Arial, Helvetica for any short in-image labels.
Keep the palette anchored in Neon Volt (#faff69), Near Black (#141414), and Neon Volt (#faff69).
Preserve these signature cues: Pure black canvas (#000000) with neon yellow-green (#faff69) accent — maximum contrast, Extra-heavy display typography: Inter at weight 900 (Black) up to 96px, and Dark charcoal card system with #414141 borders at 80% opacity.
...
```text
Create a closing poster image for a presentation inspired by ClickHouse.
Brand mood: ClickHouse's interface is a high-performance cockpit rendered in acid yellow-green on obsidian black — a design that screams "speed" before you read a single word.
Use Basier (__basier_a58b65), with fallbacks: Arial, Helvetica as the display-type reference and Basier (__basier_a58b65), with fallbacks: Arial, Helvetica for any short in-image labels.
Keep the palette anchored in Neon Volt (#faff69), Near Black (#141414), and Neon Volt (#faff69).
Preserve these signature cues: Pure black canvas (#000000) with neon yellow-green (#faff69) accent — maximum contrast, Extra-heavy display typography: Inter at weight 900 (Black) up to 96px, and Dark charcoal card system with #414141 borders at 80% opacity.
