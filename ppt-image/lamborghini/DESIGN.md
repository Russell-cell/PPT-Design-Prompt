# PPT-image Design System Inspired by Lamborghini

This file adapts the original web/UI-focused design system into a presentation-image system for slides.
Use it to generate cover art, chapter dividers, concept visuals, comparison plates, system diagrams, data backdrops, and closing posters that still feel unmistakably Lamborghini.

Source reference: `source/lamborghini/DESIGN.md`
Adaptation date: `2026-04-22`

## 1. Visual Theme & Atmosphere

This PPT-image adaptation keeps Lamborghini's brand DNA intact, but compresses it into slide-ready visuals instead of webpage UI.
The first priority is to preserve the original atmosphere: Lamborghini's website is a cathedral of darkness — a digital stage where jet-black surfaces stretch infinitely and every element emerges from the void like a machine under a spotlight.
...
- Preserve the brand's strongest cues: True black (#000000) dominant surfaces with white and gold as the only relief colors, LamboType custom Neo-Grotesk font with 12° angled terminals inspired by aerodynamic car lines, Lamborghini Gold (#FFC000) as the sole accent color — used exclusively for primary CTA buttons, and All-uppercase display typography at extreme scales (120px, 80px, 54px) with tight line-heights.
- Use Lamborghini Gold (#FFC000) as the highest-signal accent when color needs to carry emphasis.
- Let Pure White (#FFFFFF) carry calmer title-safe zones and quieter data-support slides.
- Use Charcoal (#202020) for cinematic divider slides, closing posters, or contrast-heavy cover moments.
...
- Bold contrast canvas: prefer Charcoal (#202020) when the deck needs cinematic weight or a chapter reset.
- Primary accent: Lamborghini Gold (#FFC000) should carry the strongest callout, hero focal area, or high-signal data accent.
...
- Use `LamboType, Roboto, Helvetica Neue, Arial — custom Neo-Grotesk typeface by Character Type for Lamborghini's 2024 brand refresh. Available in widths from Normal to Ultracompressed and weights from Light (300) to Black. Features 12° angled terminals inspired by aerodynamic car geometry, hexagonal construction logic, and support for 200+ languages including Latin, Cyrillic, and Greek` as the reference voice for cover words, chapter titles, or one-line in-image headlines when baked text is necessary.
- Use `LamboType, Roboto, Helvetica Neue, Arial — custom Neo-Grotesk typeface by Character Type for Lamborghini's 2024 brand refresh. Available in widths from Normal to Ultracompressed and weights from Light (300) to Black. Features 12° angled terminals inspired by aerodynamic car geometry, hexagonal construction logic, and support for 200+ languages including Latin, Cyrillic, and Greek` for labels, short annotations, numerals, or tiny UI-like callouts inside the art.
...
- Use Lamborghini's strongest visual cues as one large, unmistakable scene or object.
- Let Lamborghini Gold (#FFC000), Pure White (#FFFFFF), and Charcoal (#202020) establish the hierarchy before adding any text.
...
- Translate abstract ideas into one visual metaphor that still feels native to Lamborghini.
...
- Let the palette do part of the comparison work: Pure White (#FFFFFF) versus Charcoal (#202020), with Lamborghini Gold (#FFC000) reserved for the decisive signal.
...
- Brand mood: Lamborghini's website is a cathedral of darkness — a digital stage where jet-black surfaces stretch infinitely and every element emerges from the void like a machine under a spotlight.
- Display voice: `LamboType, Roboto, Helvetica Neue, Arial — custom Neo-Grotesk typeface by Character Type for Lamborghini's 2024 brand refresh. Available in widths from Normal to Ultracompressed and weights from Light (300) to Black. Features 12° angled terminals inspired by aerodynamic car geometry, hexagonal construction logic, and support for 200+ languages including Latin, Cyrillic, and Greek`
- Body / label voice: `LamboType, Roboto, Helvetica Neue, Arial — custom Neo-Grotesk typeface by Character Type for Lamborghini's 2024 brand refresh. Available in widths from Normal to Ultracompressed and weights from Light (300) to Black. Features 12° angled terminals inspired by aerodynamic car geometry, hexagonal construction logic, and support for 200+ languages including Latin, Cyrillic, and Greek`
- Primary accent: Lamborghini Gold (#FFC000)
- Light surface anchor: Pure White (#FFFFFF)
- Dark surface anchor: Charcoal (#202020)
- Signature cues: True black (#000000) dominant surfaces with white and gold as the only relief colors, LamboType custom Neo-Grotesk font with 12° angled terminals inspired by aerodynamic car lines, Lamborghini Gold (#FFC000) as the sole accent color — used exclusively for primary CTA buttons, and All-uppercase display typography at extreme scales (120px, 80px, 54px) with tight line-heights
...
```text
Create a presentation cover image for a presentation inspired by Lamborghini.
Brand mood: Lamborghini's website is a cathedral of darkness — a digital stage where jet-black surfaces stretch infinitely and every element emerges from the void like a machine under a spotlight.
Use LamboType, Roboto, Helvetica Neue, Arial — custom Neo-Grotesk typeface by Character Type for Lamborghini's 2024 brand refresh. Available in widths from Normal to Ultracompressed and weights from Light (300) to Black. Features 12° angled terminals inspired by aerodynamic car geometry, hexagonal construction logic, and support for 200+ languages including Latin, Cyrillic, and Greek as the display-type reference and LamboType, Roboto, Helvetica Neue, Arial — custom Neo-Grotesk typeface by Character Type for Lamborghini's 2024 brand refresh. Available in widths from Normal to Ultracompressed and weights from Light (300) to Black. Features 12° angled terminals inspired by aerodynamic car geometry, hexagonal construction logic, and support for 200+ languages including Latin, Cyrillic, and Greek for any short in-image labels.
Keep the palette anchored in Pure White (#FFFFFF), Charcoal (#202020), and Lamborghini Gold (#FFC000).
Preserve these signature cues: True black (#000000) dominant surfaces with white and gold as the only relief colors, LamboType custom Neo-Grotesk font with 12° angled terminals inspired by aerodynamic car lines, and Lamborghini Gold (#FFC000) as the sole accent color — used exclusively for primary CTA buttons.
...
```text
Create a section divider image for a presentation inspired by Lamborghini.
Brand mood: Lamborghini's website is a cathedral of darkness — a digital stage where jet-black surfaces stretch infinitely and every element emerges from the void like a machine under a spotlight.
Use LamboType, Roboto, Helvetica Neue, Arial — custom Neo-Grotesk typeface by Character Type for Lamborghini's 2024 brand refresh. Available in widths from Normal to Ultracompressed and weights from Light (300) to Black. Features 12° angled terminals inspired by aerodynamic car geometry, hexagonal construction logic, and support for 200+ languages including Latin, Cyrillic, and Greek as the display-type reference and LamboType, Roboto, Helvetica Neue, Arial — custom Neo-Grotesk typeface by Character Type for Lamborghini's 2024 brand refresh. Available in widths from Normal to Ultracompressed and weights from Light (300) to Black. Features 12° angled terminals inspired by aerodynamic car geometry, hexagonal construction logic, and support for 200+ languages including Latin, Cyrillic, and Greek for any short in-image labels.
Keep the palette anchored in Pure White (#FFFFFF), Charcoal (#202020), and Lamborghini Gold (#FFC000).
Preserve these signature cues: True black (#000000) dominant surfaces with white and gold as the only relief colors, LamboType custom Neo-Grotesk font with 12° angled terminals inspired by aerodynamic car lines, and Lamborghini Gold (#FFC000) as the sole accent color — used exclusively for primary CTA buttons.
...
```text
Create a concept visualization image for a presentation inspired by Lamborghini.
Brand mood: Lamborghini's website is a cathedral of darkness — a digital stage where jet-black surfaces stretch infinitely and every element emerges from the void like a machine under a spotlight.
Use LamboType, Roboto, Helvetica Neue, Arial — custom Neo-Grotesk typeface by Character Type for Lamborghini's 2024 brand refresh. Available in widths from Normal to Ultracompressed and weights from Light (300) to Black. Features 12° angled terminals inspired by aerodynamic car geometry, hexagonal construction logic, and support for 200+ languages including Latin, Cyrillic, and Greek as the display-type reference and LamboType, Roboto, Helvetica Neue, Arial — custom Neo-Grotesk typeface by Character Type for Lamborghini's 2024 brand refresh. Available in widths from Normal to Ultracompressed and weights from Light (300) to Black. Features 12° angled terminals inspired by aerodynamic car geometry, hexagonal construction logic, and support for 200+ languages including Latin, Cyrillic, and Greek for any short in-image labels.
Keep the palette anchored in Pure White (#FFFFFF), Charcoal (#202020), and Lamborghini Gold (#FFC000).
Preserve these signature cues: True black (#000000) dominant surfaces with white and gold as the only relief colors, LamboType custom Neo-Grotesk font with 12° angled terminals inspired by aerodynamic car lines, and Lamborghini Gold (#FFC000) as the sole accent color — used exclusively for primary CTA buttons.
...
```text
Create a comparison image for a presentation inspired by Lamborghini.
Brand mood: Lamborghini's website is a cathedral of darkness — a digital stage where jet-black surfaces stretch infinitely and every element emerges from the void like a machine under a spotlight.
Use LamboType, Roboto, Helvetica Neue, Arial — custom Neo-Grotesk typeface by Character Type for Lamborghini's 2024 brand refresh. Available in widths from Normal to Ultracompressed and weights from Light (300) to Black. Features 12° angled terminals inspired by aerodynamic car geometry, hexagonal construction logic, and support for 200+ languages including Latin, Cyrillic, and Greek as the display-type reference and LamboType, Roboto, Helvetica Neue, Arial — custom Neo-Grotesk typeface by Character Type for Lamborghini's 2024 brand refresh. Available in widths from Normal to Ultracompressed and weights from Light (300) to Black. Features 12° angled terminals inspired by aerodynamic car geometry, hexagonal construction logic, and support for 200+ languages including Latin, Cyrillic, and Greek for any short in-image labels.
Keep the palette anchored in Pure White (#FFFFFF), Charcoal (#202020), and Lamborghini Gold (#FFC000).
Preserve these signature cues: True black (#000000) dominant surfaces with white and gold as the only relief colors, LamboType custom Neo-Grotesk font with 12° angled terminals inspired by aerodynamic car lines, and Lamborghini Gold (#FFC000) as the sole accent color — used exclusively for primary CTA buttons.
...
```text
Create a data-support backdrop image for a presentation inspired by Lamborghini.
Brand mood: Lamborghini's website is a cathedral of darkness — a digital stage where jet-black surfaces stretch infinitely and every element emerges from the void like a machine under a spotlight.
Use LamboType, Roboto, Helvetica Neue, Arial — custom Neo-Grotesk typeface by Character Type for Lamborghini's 2024 brand refresh. Available in widths from Normal to Ultracompressed and weights from Light (300) to Black. Features 12° angled terminals inspired by aerodynamic car geometry, hexagonal construction logic, and support for 200+ languages including Latin, Cyrillic, and Greek as the display-type reference and LamboType, Roboto, Helvetica Neue, Arial — custom Neo-Grotesk typeface by Character Type for Lamborghini's 2024 brand refresh. Available in widths from Normal to Ultracompressed and weights from Light (300) to Black. Features 12° angled terminals inspired by aerodynamic car geometry, hexagonal construction logic, and support for 200+ languages including Latin, Cyrillic, and Greek for any short in-image labels.
Keep the palette anchored in Pure White (#FFFFFF), Charcoal (#202020), and Lamborghini Gold (#FFC000).
Preserve these signature cues: True black (#000000) dominant surfaces with white and gold as the only relief colors, LamboType custom Neo-Grotesk font with 12° angled terminals inspired by aerodynamic car lines, and Lamborghini Gold (#FFC000) as the sole accent color — used exclusively for primary CTA buttons.
...
```text
Create a closing poster image for a presentation inspired by Lamborghini.
Brand mood: Lamborghini's website is a cathedral of darkness — a digital stage where jet-black surfaces stretch infinitely and every element emerges from the void like a machine under a spotlight.
Use LamboType, Roboto, Helvetica Neue, Arial — custom Neo-Grotesk typeface by Character Type for Lamborghini's 2024 brand refresh. Available in widths from Normal to Ultracompressed and weights from Light (300) to Black. Features 12° angled terminals inspired by aerodynamic car geometry, hexagonal construction logic, and support for 200+ languages including Latin, Cyrillic, and Greek as the display-type reference and LamboType, Roboto, Helvetica Neue, Arial — custom Neo-Grotesk typeface by Character Type for Lamborghini's 2024 brand refresh. Available in widths from Normal to Ultracompressed and weights from Light (300) to Black. Features 12° angled terminals inspired by aerodynamic car geometry, hexagonal construction logic, and support for 200+ languages including Latin, Cyrillic, and Greek for any short in-image labels.
Keep the palette anchored in Pure White (#FFFFFF), Charcoal (#202020), and Lamborghini Gold (#FFC000).
Preserve these signature cues: True black (#000000) dominant surfaces with white and gold as the only relief colors, LamboType custom Neo-Grotesk font with 12° angled terminals inspired by aerodynamic car lines, and Lamborghini Gold (#FFC000) as the sole accent color — used exclusively for primary CTA buttons.
