# PPT-image Design System Inspired by Linear

This file adapts the original web/UI-focused design system into a presentation-image system for slides.
Use it to generate cover art, chapter dividers, concept visuals, comparison plates, system diagrams, data backdrops, and closing posters that still feel unmistakably Linear.

Source reference: `source/linear.app/DESIGN.md`
Adaptation date: `2026-04-22`

## 1. Visual Theme & Atmosphere

This PPT-image adaptation keeps Linear's brand DNA intact, but compresses it into slide-ready visuals instead of webpage UI.
The first priority is to preserve the original atmosphere: Linear's website is a masterclass in dark-mode-first product design — a near-black canvas (#08090a) where content emerges from darkness like starlight.
...
- Preserve the brand's strongest cues: Dark-mode-native: #08090a marketing background, #0f1011 panel background, #191a1b elevated surfaces, Inter Variable with "cv01", "ss03" globally — geometric alternates for a cleaner aesthetic, Signature weight 510 (between regular and medium) for most UI text, and Aggressive negative letter-spacing at display sizes (-1.584px at 72px, -1.056px at 48px).
- Use Brand Indigo (#5e6ad2) as the highest-signal accent when color needs to carry emphasis.
- Let Pure White (#ffffff) carry calmer title-safe zones and quieter data-support slides.
- Use Panel Dark (#0f1011) for cinematic divider slides, closing posters, or contrast-heavy cover moments.
...
- Bold contrast canvas: prefer Panel Dark (#0f1011) when the deck needs cinematic weight or a chapter reset.
- Primary accent: Brand Indigo (#5e6ad2) should carry the strongest callout, hero focal area, or high-signal data accent.
...
- Use `Inter Variable, with fallbacks: SF Pro Display, -apple-system, system-ui, Segoe UI, Roboto, Oxygen, Ubuntu, Cantarell, Open Sans, Helvetica Neue` as the reference voice for cover words, chapter titles, or one-line in-image headlines when baked text is necessary.
- Use `Berkeley Mono, with fallbacks: ui-monospace, SF Mono, Menlo` for labels, short annotations, numerals, or tiny UI-like callouts inside the art.
...
- Use Linear's strongest visual cues as one large, unmistakable scene or object.
- Let Brand Indigo (#5e6ad2), Pure White (#ffffff), and Panel Dark (#0f1011) establish the hierarchy before adding any text.
- Pull attitude from Buttons, Cards & Containers, Inputs & Forms, and Badges & Pills rather than recreating literal buttons, nav bars, or forms.
...
- Translate abstract ideas into one visual metaphor that still feels native to Linear.
...
- Let the palette do part of the comparison work: Pure White (#ffffff) versus Panel Dark (#0f1011), with Brand Indigo (#5e6ad2) reserved for the decisive signal.
...
- Brand mood: Linear's website is a masterclass in dark-mode-first product design — a near-black canvas (#08090a) where content emerges from darkness like starlight.
- Display voice: `Inter Variable, with fallbacks: SF Pro Display, -apple-system, system-ui, Segoe UI, Roboto, Oxygen, Ubuntu, Cantarell, Open Sans, Helvetica Neue`
- Body / label voice: `Berkeley Mono, with fallbacks: ui-monospace, SF Mono, Menlo`
- Primary accent: Brand Indigo (#5e6ad2)
- Light surface anchor: Pure White (#ffffff)
- Dark surface anchor: Panel Dark (#0f1011)
- Signature cues: Dark-mode-native: #08090a marketing background, #0f1011 panel background, #191a1b elevated surfaces, Inter Variable with "cv01", "ss03" globally — geometric alternates for a cleaner aesthetic, Signature weight 510 (between regular and medium) for most UI text, and Aggressive negative letter-spacing at display sizes (-1.584px at 72px, -1.056px at 48px)
...
```text
Create a presentation cover image for a presentation inspired by Linear.
Brand mood: Linear's website is a masterclass in dark-mode-first product design — a near-black canvas (#08090a) where content emerges from darkness like starlight.
Use Inter Variable, with fallbacks: SF Pro Display, -apple-system, system-ui, Segoe UI, Roboto, Oxygen, Ubuntu, Cantarell, Open Sans, Helvetica Neue as the display-type reference and Berkeley Mono, with fallbacks: ui-monospace, SF Mono, Menlo for any short in-image labels.
Keep the palette anchored in Pure White (#ffffff), Panel Dark (#0f1011), and Brand Indigo (#5e6ad2).
Preserve these signature cues: Dark-mode-native: #08090a marketing background, #0f1011 panel background, #191a1b elevated surfaces, Inter Variable with "cv01", "ss03" globally — geometric alternates for a cleaner aesthetic, and Signature weight 510 (between regular and medium) for most UI text.
...
```text
Create a section divider image for a presentation inspired by Linear.
Brand mood: Linear's website is a masterclass in dark-mode-first product design — a near-black canvas (#08090a) where content emerges from darkness like starlight.
Use Inter Variable, with fallbacks: SF Pro Display, -apple-system, system-ui, Segoe UI, Roboto, Oxygen, Ubuntu, Cantarell, Open Sans, Helvetica Neue as the display-type reference and Berkeley Mono, with fallbacks: ui-monospace, SF Mono, Menlo for any short in-image labels.
Keep the palette anchored in Pure White (#ffffff), Panel Dark (#0f1011), and Brand Indigo (#5e6ad2).
Preserve these signature cues: Dark-mode-native: #08090a marketing background, #0f1011 panel background, #191a1b elevated surfaces, Inter Variable with "cv01", "ss03" globally — geometric alternates for a cleaner aesthetic, and Signature weight 510 (between regular and medium) for most UI text.
...
```text
Create a concept visualization image for a presentation inspired by Linear.
Brand mood: Linear's website is a masterclass in dark-mode-first product design — a near-black canvas (#08090a) where content emerges from darkness like starlight.
Use Inter Variable, with fallbacks: SF Pro Display, -apple-system, system-ui, Segoe UI, Roboto, Oxygen, Ubuntu, Cantarell, Open Sans, Helvetica Neue as the display-type reference and Berkeley Mono, with fallbacks: ui-monospace, SF Mono, Menlo for any short in-image labels.
Keep the palette anchored in Pure White (#ffffff), Panel Dark (#0f1011), and Brand Indigo (#5e6ad2).
Preserve these signature cues: Dark-mode-native: #08090a marketing background, #0f1011 panel background, #191a1b elevated surfaces, Inter Variable with "cv01", "ss03" globally — geometric alternates for a cleaner aesthetic, and Signature weight 510 (between regular and medium) for most UI text.
...
```text
Create a comparison image for a presentation inspired by Linear.
Brand mood: Linear's website is a masterclass in dark-mode-first product design — a near-black canvas (#08090a) where content emerges from darkness like starlight.
Use Inter Variable, with fallbacks: SF Pro Display, -apple-system, system-ui, Segoe UI, Roboto, Oxygen, Ubuntu, Cantarell, Open Sans, Helvetica Neue as the display-type reference and Berkeley Mono, with fallbacks: ui-monospace, SF Mono, Menlo for any short in-image labels.
Keep the palette anchored in Pure White (#ffffff), Panel Dark (#0f1011), and Brand Indigo (#5e6ad2).
Preserve these signature cues: Dark-mode-native: #08090a marketing background, #0f1011 panel background, #191a1b elevated surfaces, Inter Variable with "cv01", "ss03" globally — geometric alternates for a cleaner aesthetic, and Signature weight 510 (between regular and medium) for most UI text.
...
```text
Create a data-support backdrop image for a presentation inspired by Linear.
Brand mood: Linear's website is a masterclass in dark-mode-first product design — a near-black canvas (#08090a) where content emerges from darkness like starlight.
Use Inter Variable, with fallbacks: SF Pro Display, -apple-system, system-ui, Segoe UI, Roboto, Oxygen, Ubuntu, Cantarell, Open Sans, Helvetica Neue as the display-type reference and Berkeley Mono, with fallbacks: ui-monospace, SF Mono, Menlo for any short in-image labels.
Keep the palette anchored in Pure White (#ffffff), Panel Dark (#0f1011), and Brand Indigo (#5e6ad2).
Preserve these signature cues: Dark-mode-native: #08090a marketing background, #0f1011 panel background, #191a1b elevated surfaces, Inter Variable with "cv01", "ss03" globally — geometric alternates for a cleaner aesthetic, and Signature weight 510 (between regular and medium) for most UI text.
...
```text
Create a closing poster image for a presentation inspired by Linear.
Brand mood: Linear's website is a masterclass in dark-mode-first product design — a near-black canvas (#08090a) where content emerges from darkness like starlight.
Use Inter Variable, with fallbacks: SF Pro Display, -apple-system, system-ui, Segoe UI, Roboto, Oxygen, Ubuntu, Cantarell, Open Sans, Helvetica Neue as the display-type reference and Berkeley Mono, with fallbacks: ui-monospace, SF Mono, Menlo for any short in-image labels.
Keep the palette anchored in Pure White (#ffffff), Panel Dark (#0f1011), and Brand Indigo (#5e6ad2).
Preserve these signature cues: Dark-mode-native: #08090a marketing background, #0f1011 panel background, #191a1b elevated surfaces, Inter Variable with "cv01", "ss03" globally — geometric alternates for a cleaner aesthetic, and Signature weight 510 (between regular and medium) for most UI text.
