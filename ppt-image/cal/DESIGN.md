# PPT-image Design System Inspired by Cal.com

This file adapts the original web/UI-focused design system into a presentation-image system for slides.
Use it to generate cover art, chapter dividers, concept visuals, comparison plates, system diagrams, data backdrops, and closing posters that still feel unmistakably Cal.com.

Source reference: `source/cal/DESIGN.md`
Adaptation date: `2026-04-22`

## 1. Visual Theme & Atmosphere

This PPT-image adaptation keeps Cal.com's brand DNA intact, but compresses it into slide-ready visuals instead of webpage UI.
The first priority is to preserve the original atmosphere: Cal.com's website is a masterclass in monochromatic restraint — a grayscale world where boldness comes not from color but from the sheer confidence of black text on white space.
...
- Preserve the brand's strongest cues: Purely grayscale brand palette — no brand colors, boldness through monochrome, Cal Sans custom geometric display font with extremely tight default letter-spacing, Multi-layered shadow system (11 definitions) with ring borders + diffused shadows + inset highlights, and Cal Sans for headings, Inter for body — clean typographic division.
- Use Link Blue (#0099ff) as the highest-signal accent when color needs to carry emphasis.
- Let White (#ffffff) carry calmer title-safe zones and quieter data-support slides.
- Use Charcoal (#242424) for cinematic divider slides, closing posters, or contrast-heavy cover moments.
...
- Bold contrast canvas: prefer Charcoal (#242424) when the deck needs cinematic weight or a chapter reset.
- Primary accent: Link Blue (#0099ff) should carry the strongest callout, hero focal area, or high-signal data accent.
...
- Use `Cal Sans — custom geometric sans-serif by Mark Davis. Open-source, available on Google Fonts and GitHub. Extremely tight default letter-spacing designed for large headlines. Has 6 character variants (Cc, j, t, u, 0, 1)` as the reference voice for cover words, chapter titles, or one-line in-image headlines when baked text is necessary.
- Use `Inter — "rock-solid" standard body font. Fallback: Inter Placeholder` for labels, short annotations, numerals, or tiny UI-like callouts inside the art.
...
- Use Cal.com's strongest visual cues as one large, unmistakable scene or object.
- Let Link Blue (#0099ff), White (#ffffff), and Charcoal (#242424) establish the hierarchy before adding any text.
...
- Translate abstract ideas into one visual metaphor that still feels native to Cal.com.
...
- Let the palette do part of the comparison work: White (#ffffff) versus Charcoal (#242424), with Link Blue (#0099ff) reserved for the decisive signal.
...
- Brand mood: Cal.com's website is a masterclass in monochromatic restraint — a grayscale world where boldness comes not from color but from the sheer confidence of black text on white space.
- Display voice: `Cal Sans — custom geometric sans-serif by Mark Davis. Open-source, available on Google Fonts and GitHub. Extremely tight default letter-spacing designed for large headlines. Has 6 character variants (Cc, j, t, u, 0, 1)`
- Body / label voice: `Inter — "rock-solid" standard body font. Fallback: Inter Placeholder`
- Primary accent: Link Blue (#0099ff)
- Light surface anchor: White (#ffffff)
- Dark surface anchor: Charcoal (#242424)
- Signature cues: Purely grayscale brand palette — no brand colors, boldness through monochrome, Cal Sans custom geometric display font with extremely tight default letter-spacing, Multi-layered shadow system (11 definitions) with ring borders + diffused shadows + inset highlights, and Cal Sans for headings, Inter for body — clean typographic division
...
```text
Create a presentation cover image for a presentation inspired by Cal.com.
Brand mood: Cal.com's website is a masterclass in monochromatic restraint — a grayscale world where boldness comes not from color but from the sheer confidence of black text on white space.
Use Cal Sans — custom geometric sans-serif by Mark Davis. Open-source, available on Google Fonts and GitHub. Extremely tight default letter-spacing designed for large headlines. Has 6 character variants (Cc, j, t, u, 0, 1) as the display-type reference and Inter — "rock-solid" standard body font. Fallback: Inter Placeholder for any short in-image labels.
Keep the palette anchored in White (#ffffff), Charcoal (#242424), and Link Blue (#0099ff).
Preserve these signature cues: Purely grayscale brand palette — no brand colors, boldness through monochrome, Cal Sans custom geometric display font with extremely tight default letter-spacing, and Multi-layered shadow system (11 definitions) with ring borders + diffused shadows + inset highlights.
...
```text
Create a section divider image for a presentation inspired by Cal.com.
Brand mood: Cal.com's website is a masterclass in monochromatic restraint — a grayscale world where boldness comes not from color but from the sheer confidence of black text on white space.
Use Cal Sans — custom geometric sans-serif by Mark Davis. Open-source, available on Google Fonts and GitHub. Extremely tight default letter-spacing designed for large headlines. Has 6 character variants (Cc, j, t, u, 0, 1) as the display-type reference and Inter — "rock-solid" standard body font. Fallback: Inter Placeholder for any short in-image labels.
Keep the palette anchored in White (#ffffff), Charcoal (#242424), and Link Blue (#0099ff).
Preserve these signature cues: Purely grayscale brand palette — no brand colors, boldness through monochrome, Cal Sans custom geometric display font with extremely tight default letter-spacing, and Multi-layered shadow system (11 definitions) with ring borders + diffused shadows + inset highlights.
...
```text
Create a concept visualization image for a presentation inspired by Cal.com.
Brand mood: Cal.com's website is a masterclass in monochromatic restraint — a grayscale world where boldness comes not from color but from the sheer confidence of black text on white space.
Use Cal Sans — custom geometric sans-serif by Mark Davis. Open-source, available on Google Fonts and GitHub. Extremely tight default letter-spacing designed for large headlines. Has 6 character variants (Cc, j, t, u, 0, 1) as the display-type reference and Inter — "rock-solid" standard body font. Fallback: Inter Placeholder for any short in-image labels.
Keep the palette anchored in White (#ffffff), Charcoal (#242424), and Link Blue (#0099ff).
Preserve these signature cues: Purely grayscale brand palette — no brand colors, boldness through monochrome, Cal Sans custom geometric display font with extremely tight default letter-spacing, and Multi-layered shadow system (11 definitions) with ring borders + diffused shadows + inset highlights.
...
```text
Create a comparison image for a presentation inspired by Cal.com.
Brand mood: Cal.com's website is a masterclass in monochromatic restraint — a grayscale world where boldness comes not from color but from the sheer confidence of black text on white space.
Use Cal Sans — custom geometric sans-serif by Mark Davis. Open-source, available on Google Fonts and GitHub. Extremely tight default letter-spacing designed for large headlines. Has 6 character variants (Cc, j, t, u, 0, 1) as the display-type reference and Inter — "rock-solid" standard body font. Fallback: Inter Placeholder for any short in-image labels.
Keep the palette anchored in White (#ffffff), Charcoal (#242424), and Link Blue (#0099ff).
Preserve these signature cues: Purely grayscale brand palette — no brand colors, boldness through monochrome, Cal Sans custom geometric display font with extremely tight default letter-spacing, and Multi-layered shadow system (11 definitions) with ring borders + diffused shadows + inset highlights.
...
```text
Create a data-support backdrop image for a presentation inspired by Cal.com.
Brand mood: Cal.com's website is a masterclass in monochromatic restraint — a grayscale world where boldness comes not from color but from the sheer confidence of black text on white space.
Use Cal Sans — custom geometric sans-serif by Mark Davis. Open-source, available on Google Fonts and GitHub. Extremely tight default letter-spacing designed for large headlines. Has 6 character variants (Cc, j, t, u, 0, 1) as the display-type reference and Inter — "rock-solid" standard body font. Fallback: Inter Placeholder for any short in-image labels.
Keep the palette anchored in White (#ffffff), Charcoal (#242424), and Link Blue (#0099ff).
Preserve these signature cues: Purely grayscale brand palette — no brand colors, boldness through monochrome, Cal Sans custom geometric display font with extremely tight default letter-spacing, and Multi-layered shadow system (11 definitions) with ring borders + diffused shadows + inset highlights.
...
```text
Create a closing poster image for a presentation inspired by Cal.com.
Brand mood: Cal.com's website is a masterclass in monochromatic restraint — a grayscale world where boldness comes not from color but from the sheer confidence of black text on white space.
Use Cal Sans — custom geometric sans-serif by Mark Davis. Open-source, available on Google Fonts and GitHub. Extremely tight default letter-spacing designed for large headlines. Has 6 character variants (Cc, j, t, u, 0, 1) as the display-type reference and Inter — "rock-solid" standard body font. Fallback: Inter Placeholder for any short in-image labels.
Keep the palette anchored in White (#ffffff), Charcoal (#242424), and Link Blue (#0099ff).
Preserve these signature cues: Purely grayscale brand palette — no brand colors, boldness through monochrome, Cal Sans custom geometric display font with extremely tight default letter-spacing, and Multi-layered shadow system (11 definitions) with ring borders + diffused shadows + inset highlights.
