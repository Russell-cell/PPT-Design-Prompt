# PPT-image Design System Inspired by VoltAgent

This file adapts the original web/UI-focused design system into a presentation-image system for slides.
Use it to generate cover art, chapter dividers, concept visuals, comparison plates, system diagrams, data backdrops, and closing posters that still feel unmistakably VoltAgent.

Source reference: `source/voltagent/DESIGN.md`
Adaptation date: `2026-04-22`

## 1. Visual Theme & Atmosphere

This PPT-image adaptation keeps VoltAgent's brand DNA intact, but compresses it into slide-ready visuals instead of webpage UI.
The first priority is to preserve the original atmosphere: VoltAgent's interface is a deep-space command terminal for the AI age — a developer-facing darkness built on near-pure-black surfaces (#050507) where the only interruption is the electric pulse of emerald green energy.
...
- Preserve the brand's strongest cues: Carbon-black canvas (#050507) with warm-gray border containment (#3d3a39) — not cold or sterile, Single-accent identity: Emerald Signal Green (#00d992) as the sole chromatic energy source, Dual-typography system: system-ui for authoritative headings, Inter for precise UI/body text, SFMono for code credibility, and Ultra-tight heading line-heights (1.0–1.11) creating dense, compressed power blocks.
- Use Emerald Signal Green (#00d992) as the highest-signal accent when color needs to carry emphasis.
- Let Warm Parchment (#b8b3b0) carry calmer title-safe zones and quieter data-support slides.
- Use Warm Charcoal Border (#3d3a39) for cinematic divider slides, closing posters, or contrast-heavy cover moments.
...
- Base canvas: prefer Warm Parchment (#b8b3b0) when the deck needs editorial calm or readable overlay copy.
- Bold contrast canvas: prefer Warm Charcoal Border (#3d3a39) when the deck needs cinematic weight or a chapter reset.
- Primary accent: Emerald Signal Green (#00d992) should carry the strongest callout, hero focal area, or high-signal data accent.
...
- Use `system-ui, with fallbacks: -apple-system, Segoe UI, Roboto, Ubuntu, Cantarell, Noto Sans, Helvetica, Arial, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol` as the reference voice for cover words, chapter titles, or one-line in-image headlines when baked text is necessary.
- Use `Inter, with fallbacks inheriting from system-ui stack. OpenType features: "calt", "rlig" (contextual alternates and required ligatures)` for labels, short annotations, numerals, or tiny UI-like callouts inside the art.
...
- Use VoltAgent's strongest visual cues as one large, unmistakable scene or object.
- Let Emerald Signal Green (#00d992), Warm Parchment (#b8b3b0), and Warm Charcoal Border (#3d3a39) establish the hierarchy before adding any text.
...
- Translate abstract ideas into one visual metaphor that still feels native to VoltAgent.
...
- Let the palette do part of the comparison work: Warm Parchment (#b8b3b0) versus Warm Charcoal Border (#3d3a39), with Emerald Signal Green (#00d992) reserved for the decisive signal.
...
- Brand mood: VoltAgent's interface is a deep-space command terminal for the AI age — a developer-facing darkness built on near-pure-black surfaces (#050507) where the only interruption is the electric pulse of emerald green energy.
- Display voice: `system-ui, with fallbacks: -apple-system, Segoe UI, Roboto, Ubuntu, Cantarell, Noto Sans, Helvetica, Arial, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol`
- Body / label voice: `Inter, with fallbacks inheriting from system-ui stack. OpenType features: "calt", "rlig" (contextual alternates and required ligatures)`
- Primary accent: Emerald Signal Green (#00d992)
- Light surface anchor: Warm Parchment (#b8b3b0)
- Dark surface anchor: Warm Charcoal Border (#3d3a39)
- Signature cues: Carbon-black canvas (#050507) with warm-gray border containment (#3d3a39) — not cold or sterile, Single-accent identity: Emerald Signal Green (#00d992) as the sole chromatic energy source, Dual-typography system: system-ui for authoritative headings, Inter for precise UI/body text, SFMono for code credibility, and Ultra-tight heading line-heights (1.0–1.11) creating dense, compressed power blocks
...
```text
Create a presentation cover image for a presentation inspired by VoltAgent.
Brand mood: VoltAgent's interface is a deep-space command terminal for the AI age — a developer-facing darkness built on near-pure-black surfaces (#050507) where the only interruption is the electric pulse of emerald green energy.
Use system-ui, with fallbacks: -apple-system, Segoe UI, Roboto, Ubuntu, Cantarell, Noto Sans, Helvetica, Arial, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol as the display-type reference and Inter, with fallbacks inheriting from system-ui stack. OpenType features: "calt", "rlig" (contextual alternates and required ligatures) for any short in-image labels.
Keep the palette anchored in Warm Parchment (#b8b3b0), Warm Charcoal Border (#3d3a39), and Emerald Signal Green (#00d992).
Preserve these signature cues: Carbon-black canvas (#050507) with warm-gray border containment (#3d3a39) — not cold or sterile, Single-accent identity: Emerald Signal Green (#00d992) as the sole chromatic energy source, and Dual-typography system: system-ui for authoritative headings, Inter for precise UI/body text, SFMono for code credibility.
...
```text
Create a section divider image for a presentation inspired by VoltAgent.
Brand mood: VoltAgent's interface is a deep-space command terminal for the AI age — a developer-facing darkness built on near-pure-black surfaces (#050507) where the only interruption is the electric pulse of emerald green energy.
Use system-ui, with fallbacks: -apple-system, Segoe UI, Roboto, Ubuntu, Cantarell, Noto Sans, Helvetica, Arial, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol as the display-type reference and Inter, with fallbacks inheriting from system-ui stack. OpenType features: "calt", "rlig" (contextual alternates and required ligatures) for any short in-image labels.
Keep the palette anchored in Warm Parchment (#b8b3b0), Warm Charcoal Border (#3d3a39), and Emerald Signal Green (#00d992).
Preserve these signature cues: Carbon-black canvas (#050507) with warm-gray border containment (#3d3a39) — not cold or sterile, Single-accent identity: Emerald Signal Green (#00d992) as the sole chromatic energy source, and Dual-typography system: system-ui for authoritative headings, Inter for precise UI/body text, SFMono for code credibility.
...
```text
Create a concept visualization image for a presentation inspired by VoltAgent.
Brand mood: VoltAgent's interface is a deep-space command terminal for the AI age — a developer-facing darkness built on near-pure-black surfaces (#050507) where the only interruption is the electric pulse of emerald green energy.
Use system-ui, with fallbacks: -apple-system, Segoe UI, Roboto, Ubuntu, Cantarell, Noto Sans, Helvetica, Arial, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol as the display-type reference and Inter, with fallbacks inheriting from system-ui stack. OpenType features: "calt", "rlig" (contextual alternates and required ligatures) for any short in-image labels.
Keep the palette anchored in Warm Parchment (#b8b3b0), Warm Charcoal Border (#3d3a39), and Emerald Signal Green (#00d992).
Preserve these signature cues: Carbon-black canvas (#050507) with warm-gray border containment (#3d3a39) — not cold or sterile, Single-accent identity: Emerald Signal Green (#00d992) as the sole chromatic energy source, and Dual-typography system: system-ui for authoritative headings, Inter for precise UI/body text, SFMono for code credibility.
...
```text
Create a comparison image for a presentation inspired by VoltAgent.
Brand mood: VoltAgent's interface is a deep-space command terminal for the AI age — a developer-facing darkness built on near-pure-black surfaces (#050507) where the only interruption is the electric pulse of emerald green energy.
Use system-ui, with fallbacks: -apple-system, Segoe UI, Roboto, Ubuntu, Cantarell, Noto Sans, Helvetica, Arial, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol as the display-type reference and Inter, with fallbacks inheriting from system-ui stack. OpenType features: "calt", "rlig" (contextual alternates and required ligatures) for any short in-image labels.
Keep the palette anchored in Warm Parchment (#b8b3b0), Warm Charcoal Border (#3d3a39), and Emerald Signal Green (#00d992).
Preserve these signature cues: Carbon-black canvas (#050507) with warm-gray border containment (#3d3a39) — not cold or sterile, Single-accent identity: Emerald Signal Green (#00d992) as the sole chromatic energy source, and Dual-typography system: system-ui for authoritative headings, Inter for precise UI/body text, SFMono for code credibility.
...
```text
Create a data-support backdrop image for a presentation inspired by VoltAgent.
Brand mood: VoltAgent's interface is a deep-space command terminal for the AI age — a developer-facing darkness built on near-pure-black surfaces (#050507) where the only interruption is the electric pulse of emerald green energy.
Use system-ui, with fallbacks: -apple-system, Segoe UI, Roboto, Ubuntu, Cantarell, Noto Sans, Helvetica, Arial, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol as the display-type reference and Inter, with fallbacks inheriting from system-ui stack. OpenType features: "calt", "rlig" (contextual alternates and required ligatures) for any short in-image labels.
Keep the palette anchored in Warm Parchment (#b8b3b0), Warm Charcoal Border (#3d3a39), and Emerald Signal Green (#00d992).
Preserve these signature cues: Carbon-black canvas (#050507) with warm-gray border containment (#3d3a39) — not cold or sterile, Single-accent identity: Emerald Signal Green (#00d992) as the sole chromatic energy source, and Dual-typography system: system-ui for authoritative headings, Inter for precise UI/body text, SFMono for code credibility.
...
```text
Create a closing poster image for a presentation inspired by VoltAgent.
Brand mood: VoltAgent's interface is a deep-space command terminal for the AI age — a developer-facing darkness built on near-pure-black surfaces (#050507) where the only interruption is the electric pulse of emerald green energy.
Use system-ui, with fallbacks: -apple-system, Segoe UI, Roboto, Ubuntu, Cantarell, Noto Sans, Helvetica, Arial, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol as the display-type reference and Inter, with fallbacks inheriting from system-ui stack. OpenType features: "calt", "rlig" (contextual alternates and required ligatures) for any short in-image labels.
Keep the palette anchored in Warm Parchment (#b8b3b0), Warm Charcoal Border (#3d3a39), and Emerald Signal Green (#00d992).
Preserve these signature cues: Carbon-black canvas (#050507) with warm-gray border containment (#3d3a39) — not cold or sterile, Single-accent identity: Emerald Signal Green (#00d992) as the sole chromatic energy source, and Dual-typography system: system-ui for authoritative headings, Inter for precise UI/body text, SFMono for code credibility.
