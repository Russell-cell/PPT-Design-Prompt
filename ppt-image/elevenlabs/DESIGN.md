# PPT-image Design System Inspired by ElevenLabs

This file adapts the original web/UI-focused design system into a presentation-image system for slides.
Use it to generate cover art, chapter dividers, concept visuals, comparison plates, system diagrams, data backdrops, and closing posters that still feel unmistakably ElevenLabs.

Source reference: `source/elevenlabs/DESIGN.md`
Adaptation date: `2026-04-22`

## 1. Visual Theme & Atmosphere

This PPT-image adaptation keeps ElevenLabs's brand DNA intact, but compresses it into slide-ready visuals instead of webpage UI.
The first priority is to preserve the original atmosphere: ElevenLabs' website is a study in restrained elegance — a near-white canvas (#ffffff, #f5f5f5) where typography and subtle shadows do all the heavy lifting.
...
- Preserve the brand's strongest cues: Near-white canvas with warm undertones (#f5f5f5, #f5f2ef), Waldenburg weight 300 (light) for display — ethereal, whisper-thin headings, Inter with positive letter-spacing (0.14–0.18px) for body — airy readability, and Multi-layered shadow stacks at sub-0.1 opacity — surfaces barely exist.
- Use Ring Blue (rgb(147 197 253 / 0.5)) as the highest-signal accent when color needs to carry emphasis.
- Let Near White (#f6f6f6) carry calmer title-safe zones and quieter data-support slides.
- Use Black (#000000) for cinematic divider slides, closing posters, or contrast-heavy cover moments.
...
- Base canvas: prefer Near White (#f6f6f6) when the deck needs editorial calm or readable overlay copy.
- Bold contrast canvas: prefer Black (#000000) when the deck needs cinematic weight or a chapter reset.
- Primary accent: Ring Blue (rgb(147 197 253 / 0.5)) should carry the strongest callout, hero focal area, or high-signal data accent.
...
- Use `Waldenburg, fallback: Waldenburg Fallback` as the reference voice for cover words, chapter titles, or one-line in-image headlines when baked text is necessary.
- Use `Inter, fallback: Inter Fallback` for labels, short annotations, numerals, or tiny UI-like callouts inside the art.
...
- Use ElevenLabs's strongest visual cues as one large, unmistakable scene or object.
- Let Ring Blue (rgb(147 197 253 / 0.5)), Near White (#f6f6f6), and Black (#000000) establish the hierarchy before adding any text.
...
- Translate abstract ideas into one visual metaphor that still feels native to ElevenLabs.
...
- Let the palette do part of the comparison work: Near White (#f6f6f6) versus Black (#000000), with Ring Blue (rgb(147 197 253 / 0.5)) reserved for the decisive signal.
...
- Brand mood: ElevenLabs' website is a study in restrained elegance — a near-white canvas (#ffffff, #f5f5f5) where typography and subtle shadows do all the heavy lifting.
- Display voice: `Waldenburg, fallback: Waldenburg Fallback`
- Body / label voice: `Inter, fallback: Inter Fallback`
- Primary accent: Ring Blue (rgb(147 197 253 / 0.5))
- Light surface anchor: Near White (#f6f6f6)
- Dark surface anchor: Black (#000000)
- Signature cues: Near-white canvas with warm undertones (#f5f5f5, #f5f2ef), Waldenburg weight 300 (light) for display — ethereal, whisper-thin headings, Inter with positive letter-spacing (0.14–0.18px) for body — airy readability, and Multi-layered shadow stacks at sub-0.1 opacity — surfaces barely exist
...
```text
Create a presentation cover image for a presentation inspired by ElevenLabs.
Brand mood: ElevenLabs' website is a study in restrained elegance — a near-white canvas (#ffffff, #f5f5f5) where typography and subtle shadows do all the heavy lifting.
Use Waldenburg, fallback: Waldenburg Fallback as the display-type reference and Inter, fallback: Inter Fallback for any short in-image labels.
Keep the palette anchored in Near White (#f6f6f6), Black (#000000), and Ring Blue (rgb(147 197 253 / 0.5)).
Preserve these signature cues: Near-white canvas with warm undertones (#f5f5f5, #f5f2ef), Waldenburg weight 300 (light) for display — ethereal, whisper-thin headings, and Inter with positive letter-spacing (0.14–0.18px) for body — airy readability.
...
```text
Create a section divider image for a presentation inspired by ElevenLabs.
Brand mood: ElevenLabs' website is a study in restrained elegance — a near-white canvas (#ffffff, #f5f5f5) where typography and subtle shadows do all the heavy lifting.
Use Waldenburg, fallback: Waldenburg Fallback as the display-type reference and Inter, fallback: Inter Fallback for any short in-image labels.
Keep the palette anchored in Near White (#f6f6f6), Black (#000000), and Ring Blue (rgb(147 197 253 / 0.5)).
Preserve these signature cues: Near-white canvas with warm undertones (#f5f5f5, #f5f2ef), Waldenburg weight 300 (light) for display — ethereal, whisper-thin headings, and Inter with positive letter-spacing (0.14–0.18px) for body — airy readability.
...
```text
Create a concept visualization image for a presentation inspired by ElevenLabs.
Brand mood: ElevenLabs' website is a study in restrained elegance — a near-white canvas (#ffffff, #f5f5f5) where typography and subtle shadows do all the heavy lifting.
Use Waldenburg, fallback: Waldenburg Fallback as the display-type reference and Inter, fallback: Inter Fallback for any short in-image labels.
Keep the palette anchored in Near White (#f6f6f6), Black (#000000), and Ring Blue (rgb(147 197 253 / 0.5)).
Preserve these signature cues: Near-white canvas with warm undertones (#f5f5f5, #f5f2ef), Waldenburg weight 300 (light) for display — ethereal, whisper-thin headings, and Inter with positive letter-spacing (0.14–0.18px) for body — airy readability.
...
```text
Create a comparison image for a presentation inspired by ElevenLabs.
Brand mood: ElevenLabs' website is a study in restrained elegance — a near-white canvas (#ffffff, #f5f5f5) where typography and subtle shadows do all the heavy lifting.
Use Waldenburg, fallback: Waldenburg Fallback as the display-type reference and Inter, fallback: Inter Fallback for any short in-image labels.
Keep the palette anchored in Near White (#f6f6f6), Black (#000000), and Ring Blue (rgb(147 197 253 / 0.5)).
Preserve these signature cues: Near-white canvas with warm undertones (#f5f5f5, #f5f2ef), Waldenburg weight 300 (light) for display — ethereal, whisper-thin headings, and Inter with positive letter-spacing (0.14–0.18px) for body — airy readability.
...
```text
Create a data-support backdrop image for a presentation inspired by ElevenLabs.
Brand mood: ElevenLabs' website is a study in restrained elegance — a near-white canvas (#ffffff, #f5f5f5) where typography and subtle shadows do all the heavy lifting.
Use Waldenburg, fallback: Waldenburg Fallback as the display-type reference and Inter, fallback: Inter Fallback for any short in-image labels.
Keep the palette anchored in Near White (#f6f6f6), Black (#000000), and Ring Blue (rgb(147 197 253 / 0.5)).
Preserve these signature cues: Near-white canvas with warm undertones (#f5f5f5, #f5f2ef), Waldenburg weight 300 (light) for display — ethereal, whisper-thin headings, and Inter with positive letter-spacing (0.14–0.18px) for body — airy readability.
...
```text
Create a closing poster image for a presentation inspired by ElevenLabs.
Brand mood: ElevenLabs' website is a study in restrained elegance — a near-white canvas (#ffffff, #f5f5f5) where typography and subtle shadows do all the heavy lifting.
Use Waldenburg, fallback: Waldenburg Fallback as the display-type reference and Inter, fallback: Inter Fallback for any short in-image labels.
Keep the palette anchored in Near White (#f6f6f6), Black (#000000), and Ring Blue (rgb(147 197 253 / 0.5)).
Preserve these signature cues: Near-white canvas with warm undertones (#f5f5f5, #f5f2ef), Waldenburg weight 300 (light) for display — ethereal, whisper-thin headings, and Inter with positive letter-spacing (0.14–0.18px) for body — airy readability.
