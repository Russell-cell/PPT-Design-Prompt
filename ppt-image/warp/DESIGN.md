# PPT-image Design System Inspired by Warp

This file adapts the original web/UI-focused design system into a presentation-image system for slides.
Use it to generate cover art, chapter dividers, concept visuals, comparison plates, system diagrams, data backdrops, and closing posters that still feel unmistakably Warp.

Source reference: `source/warp/DESIGN.md`
Adaptation date: `2026-04-22`

## 1. Visual Theme & Atmosphere

This PPT-image adaptation keeps Warp's brand DNA intact, but compresses it into slide-ready visuals instead of webpage UI.
The first priority is to preserve the original atmosphere: Warp's website feels like sitting at a campfire in a deep forest — warm, dark, and alive with quiet confidence.
...
- Preserve the brand's strongest cues: Warm dark background — not cold black, but earthy near-black with warm gray undertones, Warm Parchment (#faf9f6) text instead of pure white — subtle cream warmth, Matter font family (Regular weight) — geometric but approachable, not the typical developer-tool typeface, and Nature photography interleaved with product screenshots — lifestyle meets developer tool.
- Use Muted Purple (#666469) as the highest-signal accent when color needs to carry emphasis.
- Let Warm Parchment (#faf9f6) carry calmer title-safe zones and quieter data-support slides.
- Use Earth Gray (#353534) for cinematic divider slides, closing posters, or contrast-heavy cover moments.
...
- Base canvas: prefer Warm Parchment (#faf9f6) when the deck needs editorial calm or readable overlay copy.
- Bold contrast canvas: prefer Earth Gray (#353534) when the deck needs cinematic weight or a chapter reset.
- Primary accent: Muted Purple (#666469) should carry the strongest callout, hero focal area, or high-signal data accent.
...
- Use `Matter Regular — geometric sans-serif with soft character. Fallbacks: Matter Regular Placeholder, system sans-serif` as the reference voice for cover words, chapter titles, or one-line in-image headlines when baked text is necessary.
- Use `Matter Regular — geometric sans-serif with soft character. Fallbacks: Matter Regular Placeholder, system sans-serif` for labels, short annotations, numerals, or tiny UI-like callouts inside the art.
...
- Use Warp's strongest visual cues as one large, unmistakable scene or object.
- Let Muted Purple (#666469), Warm Parchment (#faf9f6), and Earth Gray (#353534) establish the hierarchy before adding any text.
...
- Translate abstract ideas into one visual metaphor that still feels native to Warp.
...
- Let the palette do part of the comparison work: Warm Parchment (#faf9f6) versus Earth Gray (#353534), with Muted Purple (#666469) reserved for the decisive signal.
...
- Brand mood: Warp's website feels like sitting at a campfire in a deep forest — warm, dark, and alive with quiet confidence.
- Display voice: `Matter Regular — geometric sans-serif with soft character. Fallbacks: Matter Regular Placeholder, system sans-serif`
- Body / label voice: `Matter Regular — geometric sans-serif with soft character. Fallbacks: Matter Regular Placeholder, system sans-serif`
- Primary accent: Muted Purple (#666469)
- Light surface anchor: Warm Parchment (#faf9f6)
- Dark surface anchor: Earth Gray (#353534)
- Signature cues: Warm dark background — not cold black, but earthy near-black with warm gray undertones, Warm Parchment (#faf9f6) text instead of pure white — subtle cream warmth, Matter font family (Regular weight) — geometric but approachable, not the typical developer-tool typeface, and Nature photography interleaved with product screenshots — lifestyle meets developer tool
...
```text
Create a presentation cover image for a presentation inspired by Warp.
Brand mood: Warp's website feels like sitting at a campfire in a deep forest — warm, dark, and alive with quiet confidence.
Use Matter Regular — geometric sans-serif with soft character. Fallbacks: Matter Regular Placeholder, system sans-serif as the display-type reference and Matter Regular — geometric sans-serif with soft character. Fallbacks: Matter Regular Placeholder, system sans-serif for any short in-image labels.
Keep the palette anchored in Warm Parchment (#faf9f6), Earth Gray (#353534), and Muted Purple (#666469).
Preserve these signature cues: Warm dark background — not cold black, but earthy near-black with warm gray undertones, Warm Parchment (#faf9f6) text instead of pure white — subtle cream warmth, and Matter font family (Regular weight) — geometric but approachable, not the typical developer-tool typeface.
...
```text
Create a section divider image for a presentation inspired by Warp.
Brand mood: Warp's website feels like sitting at a campfire in a deep forest — warm, dark, and alive with quiet confidence.
Use Matter Regular — geometric sans-serif with soft character. Fallbacks: Matter Regular Placeholder, system sans-serif as the display-type reference and Matter Regular — geometric sans-serif with soft character. Fallbacks: Matter Regular Placeholder, system sans-serif for any short in-image labels.
Keep the palette anchored in Warm Parchment (#faf9f6), Earth Gray (#353534), and Muted Purple (#666469).
Preserve these signature cues: Warm dark background — not cold black, but earthy near-black with warm gray undertones, Warm Parchment (#faf9f6) text instead of pure white — subtle cream warmth, and Matter font family (Regular weight) — geometric but approachable, not the typical developer-tool typeface.
...
```text
Create a concept visualization image for a presentation inspired by Warp.
Brand mood: Warp's website feels like sitting at a campfire in a deep forest — warm, dark, and alive with quiet confidence.
Use Matter Regular — geometric sans-serif with soft character. Fallbacks: Matter Regular Placeholder, system sans-serif as the display-type reference and Matter Regular — geometric sans-serif with soft character. Fallbacks: Matter Regular Placeholder, system sans-serif for any short in-image labels.
Keep the palette anchored in Warm Parchment (#faf9f6), Earth Gray (#353534), and Muted Purple (#666469).
Preserve these signature cues: Warm dark background — not cold black, but earthy near-black with warm gray undertones, Warm Parchment (#faf9f6) text instead of pure white — subtle cream warmth, and Matter font family (Regular weight) — geometric but approachable, not the typical developer-tool typeface.
...
```text
Create a comparison image for a presentation inspired by Warp.
Brand mood: Warp's website feels like sitting at a campfire in a deep forest — warm, dark, and alive with quiet confidence.
Use Matter Regular — geometric sans-serif with soft character. Fallbacks: Matter Regular Placeholder, system sans-serif as the display-type reference and Matter Regular — geometric sans-serif with soft character. Fallbacks: Matter Regular Placeholder, system sans-serif for any short in-image labels.
Keep the palette anchored in Warm Parchment (#faf9f6), Earth Gray (#353534), and Muted Purple (#666469).
Preserve these signature cues: Warm dark background — not cold black, but earthy near-black with warm gray undertones, Warm Parchment (#faf9f6) text instead of pure white — subtle cream warmth, and Matter font family (Regular weight) — geometric but approachable, not the typical developer-tool typeface.
...
```text
Create a data-support backdrop image for a presentation inspired by Warp.
Brand mood: Warp's website feels like sitting at a campfire in a deep forest — warm, dark, and alive with quiet confidence.
Use Matter Regular — geometric sans-serif with soft character. Fallbacks: Matter Regular Placeholder, system sans-serif as the display-type reference and Matter Regular — geometric sans-serif with soft character. Fallbacks: Matter Regular Placeholder, system sans-serif for any short in-image labels.
Keep the palette anchored in Warm Parchment (#faf9f6), Earth Gray (#353534), and Muted Purple (#666469).
Preserve these signature cues: Warm dark background — not cold black, but earthy near-black with warm gray undertones, Warm Parchment (#faf9f6) text instead of pure white — subtle cream warmth, and Matter font family (Regular weight) — geometric but approachable, not the typical developer-tool typeface.
...
```text
Create a closing poster image for a presentation inspired by Warp.
Brand mood: Warp's website feels like sitting at a campfire in a deep forest — warm, dark, and alive with quiet confidence.
Use Matter Regular — geometric sans-serif with soft character. Fallbacks: Matter Regular Placeholder, system sans-serif as the display-type reference and Matter Regular — geometric sans-serif with soft character. Fallbacks: Matter Regular Placeholder, system sans-serif for any short in-image labels.
Keep the palette anchored in Warm Parchment (#faf9f6), Earth Gray (#353534), and Muted Purple (#666469).
Preserve these signature cues: Warm dark background — not cold black, but earthy near-black with warm gray undertones, Warm Parchment (#faf9f6) text instead of pure white — subtle cream warmth, and Matter font family (Regular weight) — geometric but approachable, not the typical developer-tool typeface.
