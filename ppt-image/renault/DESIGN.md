# PPT-image Design System Inspired by Renault

This file adapts the original web/UI-focused design system into a presentation-image system for slides.
Use it to generate cover art, chapter dividers, concept visuals, comparison plates, system diagrams, data backdrops, and closing posters that still feel unmistakably Renault.

Source reference: `source/renault/DESIGN.md`
Adaptation date: `2026-04-22`

## 1. Visual Theme & Atmosphere

This PPT-image adaptation keeps Renault's brand DNA intact, but compresses it into slide-ready visuals instead of webpage UI.
The first priority is to preserve the original atmosphere: Renault's website is a vibrant digital showroom that balances French automotive elegance with bold, forward-leaning energy — a departure from the monochromatic austerity of German or Italian luxury brands.
...
- Primary accent: Renault Yellow (#EFDF00) should carry the strongest callout, hero focal area, or high-signal data accent.
...
- Use `0.95 line-height on hero and section headings — the lines nearly collide, creating a compressed, punchy typographic texture that feels urgent and modern` as the reference voice for cover words, chapter titles, or one-line in-image headlines when baked text is necessary.
- Use `Unlike Ferrari (FerrariSans + Body-Font) or Lamborghini (LamboType + Open Sans), Renault uses a single font family for all text — headings, body, buttons, captions, and navigation` for labels, short annotations, numerals, or tiny UI-like callouts inside the art.
...
- Use Renault's strongest visual cues as one large, unmistakable scene or object.
- Let Renault Yellow (#EFDF00), Pure White (#FFFFFF), and Absolute Black (#000000) establish the hierarchy before adding any text.
...
- Translate abstract ideas into one visual metaphor that still feels native to Renault.
...
- Let the palette do part of the comparison work: Pure White (#FFFFFF) versus Absolute Black (#000000), with Renault Yellow (#EFDF00) reserved for the decisive signal.
...
- Brand mood: Renault's website is a vibrant digital showroom that balances French automotive elegance with bold, forward-leaning energy — a departure from the monochromatic austerity of German or Italian luxury brands.
- Display voice: `0.95 line-height on hero and section headings — the lines nearly collide, creating a compressed, punchy typographic texture that feels urgent and modern`
- Body / label voice: `Unlike Ferrari (FerrariSans + Body-Font) or Lamborghini (LamboType + Open Sans), Renault uses a single font family for all text — headings, body, buttons, captions, and navigation`
- Primary accent: Renault Yellow (#EFDF00)
...
```text
Create a presentation cover image for a presentation inspired by Renault.
Brand mood: Renault's website is a vibrant digital showroom that balances French automotive elegance with bold, forward-leaning energy — a departure from the monochromatic austerity of German or Italian luxury brands.
Use 0.95 line-height on hero and section headings — the lines nearly collide, creating a compressed, punchy typographic texture that feels urgent and modern as the display-type reference and Unlike Ferrari (FerrariSans + Body-Font) or Lamborghini (LamboType + Open Sans), Renault uses a single font family for all text — headings, body, buttons, captions, and navigation for any short in-image labels.
Keep the palette anchored in Pure White (#FFFFFF), Absolute Black (#000000), and Renault Yellow (#EFDF00).
Preserve these signature cues: Full-screen hero carousel with vivid aurora gradient backgrounds (magenta/violet/teal) behind vehicle imagery, NouvelR proprietary typeface with 28-degree "radical r" cut matching the diamond logo geometry, and Renault Yellow (#EFDF00) as the super-primary accent — used sparingly for highest-priority CTAs.
...
```text
Create a section divider image for a presentation inspired by Renault.
Brand mood: Renault's website is a vibrant digital showroom that balances French automotive elegance with bold, forward-leaning energy — a departure from the monochromatic austerity of German or Italian luxury brands.
Use 0.95 line-height on hero and section headings — the lines nearly collide, creating a compressed, punchy typographic texture that feels urgent and modern as the display-type reference and Unlike Ferrari (FerrariSans + Body-Font) or Lamborghini (LamboType + Open Sans), Renault uses a single font family for all text — headings, body, buttons, captions, and navigation for any short in-image labels.
Keep the palette anchored in Pure White (#FFFFFF), Absolute Black (#000000), and Renault Yellow (#EFDF00).
Preserve these signature cues: Full-screen hero carousel with vivid aurora gradient backgrounds (magenta/violet/teal) behind vehicle imagery, NouvelR proprietary typeface with 28-degree "radical r" cut matching the diamond logo geometry, and Renault Yellow (#EFDF00) as the super-primary accent — used sparingly for highest-priority CTAs.
...
```text
Create a concept visualization image for a presentation inspired by Renault.
Brand mood: Renault's website is a vibrant digital showroom that balances French automotive elegance with bold, forward-leaning energy — a departure from the monochromatic austerity of German or Italian luxury brands.
Use 0.95 line-height on hero and section headings — the lines nearly collide, creating a compressed, punchy typographic texture that feels urgent and modern as the display-type reference and Unlike Ferrari (FerrariSans + Body-Font) or Lamborghini (LamboType + Open Sans), Renault uses a single font family for all text — headings, body, buttons, captions, and navigation for any short in-image labels.
Keep the palette anchored in Pure White (#FFFFFF), Absolute Black (#000000), and Renault Yellow (#EFDF00).
Preserve these signature cues: Full-screen hero carousel with vivid aurora gradient backgrounds (magenta/violet/teal) behind vehicle imagery, NouvelR proprietary typeface with 28-degree "radical r" cut matching the diamond logo geometry, and Renault Yellow (#EFDF00) as the super-primary accent — used sparingly for highest-priority CTAs.
...
```text
Create a comparison image for a presentation inspired by Renault.
Brand mood: Renault's website is a vibrant digital showroom that balances French automotive elegance with bold, forward-leaning energy — a departure from the monochromatic austerity of German or Italian luxury brands.
Use 0.95 line-height on hero and section headings — the lines nearly collide, creating a compressed, punchy typographic texture that feels urgent and modern as the display-type reference and Unlike Ferrari (FerrariSans + Body-Font) or Lamborghini (LamboType + Open Sans), Renault uses a single font family for all text — headings, body, buttons, captions, and navigation for any short in-image labels.
Keep the palette anchored in Pure White (#FFFFFF), Absolute Black (#000000), and Renault Yellow (#EFDF00).
Preserve these signature cues: Full-screen hero carousel with vivid aurora gradient backgrounds (magenta/violet/teal) behind vehicle imagery, NouvelR proprietary typeface with 28-degree "radical r" cut matching the diamond logo geometry, and Renault Yellow (#EFDF00) as the super-primary accent — used sparingly for highest-priority CTAs.
...
```text
Create a data-support backdrop image for a presentation inspired by Renault.
Brand mood: Renault's website is a vibrant digital showroom that balances French automotive elegance with bold, forward-leaning energy — a departure from the monochromatic austerity of German or Italian luxury brands.
Use 0.95 line-height on hero and section headings — the lines nearly collide, creating a compressed, punchy typographic texture that feels urgent and modern as the display-type reference and Unlike Ferrari (FerrariSans + Body-Font) or Lamborghini (LamboType + Open Sans), Renault uses a single font family for all text — headings, body, buttons, captions, and navigation for any short in-image labels.
Keep the palette anchored in Pure White (#FFFFFF), Absolute Black (#000000), and Renault Yellow (#EFDF00).
Preserve these signature cues: Full-screen hero carousel with vivid aurora gradient backgrounds (magenta/violet/teal) behind vehicle imagery, NouvelR proprietary typeface with 28-degree "radical r" cut matching the diamond logo geometry, and Renault Yellow (#EFDF00) as the super-primary accent — used sparingly for highest-priority CTAs.
...
```text
Create a closing poster image for a presentation inspired by Renault.
Brand mood: Renault's website is a vibrant digital showroom that balances French automotive elegance with bold, forward-leaning energy — a departure from the monochromatic austerity of German or Italian luxury brands.
Use 0.95 line-height on hero and section headings — the lines nearly collide, creating a compressed, punchy typographic texture that feels urgent and modern as the display-type reference and Unlike Ferrari (FerrariSans + Body-Font) or Lamborghini (LamboType + Open Sans), Renault uses a single font family for all text — headings, body, buttons, captions, and navigation for any short in-image labels.
Keep the palette anchored in Pure White (#FFFFFF), Absolute Black (#000000), and Renault Yellow (#EFDF00).
Preserve these signature cues: Full-screen hero carousel with vivid aurora gradient backgrounds (magenta/violet/teal) behind vehicle imagery, NouvelR proprietary typeface with 28-degree "radical r" cut matching the diamond logo geometry, and Renault Yellow (#EFDF00) as the super-primary accent — used sparingly for highest-priority CTAs.
