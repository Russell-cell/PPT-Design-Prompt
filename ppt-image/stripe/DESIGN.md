# PPT-image Design System Inspired by Stripe

This file adapts the original web/UI-focused design system into a presentation-image system for slides.
Use it to generate cover art, chapter dividers, concept visuals, comparison plates, system diagrams, data backdrops, and closing posters that still feel unmistakably Stripe.

Source reference: `source/stripe/DESIGN.md`
Adaptation date: `2026-04-22`

## 1. Visual Theme & Atmosphere

This PPT-image adaptation keeps Stripe's brand DNA intact, but compresses it into slide-ready visuals instead of webpage UI.
The first priority is to preserve the original atmosphere: Stripe's website is the gold standard of fintech design -- a system that manages to feel simultaneously technical and luxurious, precise and warm.
...
- Preserve the brand's strongest cues: sohne-var with OpenType "ss01" on all text -- a custom stylistic set that defines the brand's letterforms, Weight 300 as the signature headline weight -- light, confident, anti-convention, Negative letter-spacing at display sizes (-1.4px at 56px, progressive relaxation downward), and Blue-tinted multi-layer shadows using rgba(50,50,93,0.25) -- elevation that feels brand-colored.
- Use Stripe Purple (#533afd) as the highest-signal accent when color needs to carry emphasis.
- Let Pure White (#ffffff) carry calmer title-safe zones and quieter data-support slides.
- Use Deep Navy (#061b31) for cinematic divider slides, closing posters, or contrast-heavy cover moments.
...
- Bold contrast canvas: prefer Deep Navy (#061b31) when the deck needs cinematic weight or a chapter reset.
- Primary accent: Stripe Purple (#533afd) should carry the strongest callout, hero focal area, or high-signal data accent.
...
- Use `sohne-var / fallback: SF Pro Display` as the reference voice for cover words, chapter titles, or one-line in-image headlines when baked text is necessary.
- Use `SourceCodePro / fallback: SFMono-Regular` for labels, short annotations, numerals, or tiny UI-like callouts inside the art.
...
- Use Stripe's strongest visual cues as one large, unmistakable scene or object.
- Let Stripe Purple (#533afd), Pure White (#ffffff), and Deep Navy (#061b31) establish the hierarchy before adding any text.
- Pull attitude from Buttons, Cards & Containers, Badges / Tags / Pills, and Inputs & Forms rather than recreating literal buttons, nav bars, or forms.
...
- Translate abstract ideas into one visual metaphor that still feels native to Stripe.
...
- Let the palette do part of the comparison work: Pure White (#ffffff) versus Deep Navy (#061b31), with Stripe Purple (#533afd) reserved for the decisive signal.
...
- Brand mood: Stripe's website is the gold standard of fintech design -- a system that manages to feel simultaneously technical and luxurious, precise and warm.
- Display voice: `sohne-var / fallback: SF Pro Display`
- Body / label voice: `SourceCodePro / fallback: SFMono-Regular`
- Primary accent: Stripe Purple (#533afd)
- Light surface anchor: Pure White (#ffffff)
- Dark surface anchor: Deep Navy (#061b31)
- Signature cues: sohne-var with OpenType "ss01" on all text -- a custom stylistic set that defines the brand's letterforms, Weight 300 as the signature headline weight -- light, confident, anti-convention, Negative letter-spacing at display sizes (-1.4px at 56px, progressive relaxation downward), and Blue-tinted multi-layer shadows using rgba(50,50,93,0.25) -- elevation that feels brand-colored
...
```text
Create a presentation cover image for a presentation inspired by Stripe.
Brand mood: Stripe's website is the gold standard of fintech design -- a system that manages to feel simultaneously technical and luxurious, precise and warm.
Use sohne-var / fallback: SF Pro Display as the display-type reference and SourceCodePro / fallback: SFMono-Regular for any short in-image labels.
Keep the palette anchored in Pure White (#ffffff), Deep Navy (#061b31), and Stripe Purple (#533afd).
Preserve these signature cues: sohne-var with OpenType "ss01" on all text -- a custom stylistic set that defines the brand's letterforms, Weight 300 as the signature headline weight -- light, confident, anti-convention, and Negative letter-spacing at display sizes (-1.4px at 56px, progressive relaxation downward).
...
```text
Create a section divider image for a presentation inspired by Stripe.
Brand mood: Stripe's website is the gold standard of fintech design -- a system that manages to feel simultaneously technical and luxurious, precise and warm.
Use sohne-var / fallback: SF Pro Display as the display-type reference and SourceCodePro / fallback: SFMono-Regular for any short in-image labels.
Keep the palette anchored in Pure White (#ffffff), Deep Navy (#061b31), and Stripe Purple (#533afd).
Preserve these signature cues: sohne-var with OpenType "ss01" on all text -- a custom stylistic set that defines the brand's letterforms, Weight 300 as the signature headline weight -- light, confident, anti-convention, and Negative letter-spacing at display sizes (-1.4px at 56px, progressive relaxation downward).
...
```text
Create a concept visualization image for a presentation inspired by Stripe.
Brand mood: Stripe's website is the gold standard of fintech design -- a system that manages to feel simultaneously technical and luxurious, precise and warm.
Use sohne-var / fallback: SF Pro Display as the display-type reference and SourceCodePro / fallback: SFMono-Regular for any short in-image labels.
Keep the palette anchored in Pure White (#ffffff), Deep Navy (#061b31), and Stripe Purple (#533afd).
Preserve these signature cues: sohne-var with OpenType "ss01" on all text -- a custom stylistic set that defines the brand's letterforms, Weight 300 as the signature headline weight -- light, confident, anti-convention, and Negative letter-spacing at display sizes (-1.4px at 56px, progressive relaxation downward).
...
```text
Create a comparison image for a presentation inspired by Stripe.
Brand mood: Stripe's website is the gold standard of fintech design -- a system that manages to feel simultaneously technical and luxurious, precise and warm.
Use sohne-var / fallback: SF Pro Display as the display-type reference and SourceCodePro / fallback: SFMono-Regular for any short in-image labels.
Keep the palette anchored in Pure White (#ffffff), Deep Navy (#061b31), and Stripe Purple (#533afd).
Preserve these signature cues: sohne-var with OpenType "ss01" on all text -- a custom stylistic set that defines the brand's letterforms, Weight 300 as the signature headline weight -- light, confident, anti-convention, and Negative letter-spacing at display sizes (-1.4px at 56px, progressive relaxation downward).
...
```text
Create a data-support backdrop image for a presentation inspired by Stripe.
Brand mood: Stripe's website is the gold standard of fintech design -- a system that manages to feel simultaneously technical and luxurious, precise and warm.
Use sohne-var / fallback: SF Pro Display as the display-type reference and SourceCodePro / fallback: SFMono-Regular for any short in-image labels.
Keep the palette anchored in Pure White (#ffffff), Deep Navy (#061b31), and Stripe Purple (#533afd).
Preserve these signature cues: sohne-var with OpenType "ss01" on all text -- a custom stylistic set that defines the brand's letterforms, Weight 300 as the signature headline weight -- light, confident, anti-convention, and Negative letter-spacing at display sizes (-1.4px at 56px, progressive relaxation downward).
...
```text
Create a closing poster image for a presentation inspired by Stripe.
Brand mood: Stripe's website is the gold standard of fintech design -- a system that manages to feel simultaneously technical and luxurious, precise and warm.
Use sohne-var / fallback: SF Pro Display as the display-type reference and SourceCodePro / fallback: SFMono-Regular for any short in-image labels.
Keep the palette anchored in Pure White (#ffffff), Deep Navy (#061b31), and Stripe Purple (#533afd).
Preserve these signature cues: sohne-var with OpenType "ss01" on all text -- a custom stylistic set that defines the brand's letterforms, Weight 300 as the signature headline weight -- light, confident, anti-convention, and Negative letter-spacing at display sizes (-1.4px at 56px, progressive relaxation downward).
