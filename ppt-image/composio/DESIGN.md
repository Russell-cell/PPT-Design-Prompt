# PPT-image Design System Inspired by Composio

This file adapts the original web/UI-focused design system into a presentation-image system for slides.
Use it to generate cover art, chapter dividers, concept visuals, comparison plates, system diagrams, data backdrops, and closing posters that still feel unmistakably Composio.

Source reference: `source/composio/DESIGN.md`
Adaptation date: `2026-04-22`

## 1. Visual Theme & Atmosphere

This PPT-image adaptation keeps Composio's brand DNA intact, but compresses it into slide-ready visuals instead of webpage UI.
The first priority is to preserve the original atmosphere: Composio's interface is a nocturnal command center — a dense, developer-focused darkness punctuated by electric cyan and deep cobalt signals.
...
- Preserve the brand's strongest cues: Pitch-black canvas with near-invisible white-border containment (4-12% opacity), Dual-font identity: geometric sans-serif (abcDiatype) for content, monospace (JetBrains Mono) for technical credibility, Ultra-tight heading line-heights (0.87-1.0) creating compressed, impactful text blocks, and Bioluminescent accent strategy — cyan and blue glows that feel like they're emitting light from within.
- Use Composio Cobalt (#0007cd) as the highest-signal accent when color needs to carry emphasis.
- Let Electric Cyan (#00ffff) carry calmer title-safe zones and quieter data-support slides.
- Use Void Black (#0f0f0f) for cinematic divider slides, closing posters, or contrast-heavy cover moments.
...
- Base canvas: prefer Electric Cyan (#00ffff) when the deck needs editorial calm or readable overlay copy.
- Bold contrast canvas: prefer Void Black (#0f0f0f) when the deck needs cinematic weight or a chapter reset.
- Primary accent: Composio Cobalt (#0007cd) should carry the strongest callout, hero focal area, or high-signal data accent.
...
- Use `abcDiatype, with fallbacks: abcDiatype Fallback, ui-sans-serif, system-ui, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol, Noto Color Emoji` as the reference voice for cover words, chapter titles, or one-line in-image headlines when baked text is necessary.
- Use `JetBrains Mono, with fallbacks: JetBrains Mono Fallback, ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New` for labels, short annotations, numerals, or tiny UI-like callouts inside the art.
...
- Use Composio's strongest visual cues as one large, unmistakable scene or object.
- Let Composio Cobalt (#0007cd), Electric Cyan (#00ffff), and Void Black (#0f0f0f) establish the hierarchy before adding any text.
...
- Translate abstract ideas into one visual metaphor that still feels native to Composio.
...
- Let the palette do part of the comparison work: Electric Cyan (#00ffff) versus Void Black (#0f0f0f), with Composio Cobalt (#0007cd) reserved for the decisive signal.
...
- Brand mood: Composio's interface is a nocturnal command center — a dense, developer-focused darkness punctuated by electric cyan and deep cobalt signals.
- Display voice: `abcDiatype, with fallbacks: abcDiatype Fallback, ui-sans-serif, system-ui, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol, Noto Color Emoji`
- Body / label voice: `JetBrains Mono, with fallbacks: JetBrains Mono Fallback, ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New`
- Primary accent: Composio Cobalt (#0007cd)
- Light surface anchor: Electric Cyan (#00ffff)
- Dark surface anchor: Void Black (#0f0f0f)
- Signature cues: Pitch-black canvas with near-invisible white-border containment (4-12% opacity), Dual-font identity: geometric sans-serif (abcDiatype) for content, monospace (JetBrains Mono) for technical credibility, Ultra-tight heading line-heights (0.87-1.0) creating compressed, impactful text blocks, and Bioluminescent accent strategy — cyan and blue glows that feel like they're emitting light from within
...
```text
Create a presentation cover image for a presentation inspired by Composio.
Brand mood: Composio's interface is a nocturnal command center — a dense, developer-focused darkness punctuated by electric cyan and deep cobalt signals.
Use abcDiatype, with fallbacks: abcDiatype Fallback, ui-sans-serif, system-ui, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol, Noto Color Emoji as the display-type reference and JetBrains Mono, with fallbacks: JetBrains Mono Fallback, ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New for any short in-image labels.
Keep the palette anchored in Electric Cyan (#00ffff), Void Black (#0f0f0f), and Composio Cobalt (#0007cd).
Preserve these signature cues: Pitch-black canvas with near-invisible white-border containment (4-12% opacity), Dual-font identity: geometric sans-serif (abcDiatype) for content, monospace (JetBrains Mono) for technical credibility, and Ultra-tight heading line-heights (0.87-1.0) creating compressed, impactful text blocks.
...
```text
Create a section divider image for a presentation inspired by Composio.
Brand mood: Composio's interface is a nocturnal command center — a dense, developer-focused darkness punctuated by electric cyan and deep cobalt signals.
Use abcDiatype, with fallbacks: abcDiatype Fallback, ui-sans-serif, system-ui, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol, Noto Color Emoji as the display-type reference and JetBrains Mono, with fallbacks: JetBrains Mono Fallback, ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New for any short in-image labels.
Keep the palette anchored in Electric Cyan (#00ffff), Void Black (#0f0f0f), and Composio Cobalt (#0007cd).
Preserve these signature cues: Pitch-black canvas with near-invisible white-border containment (4-12% opacity), Dual-font identity: geometric sans-serif (abcDiatype) for content, monospace (JetBrains Mono) for technical credibility, and Ultra-tight heading line-heights (0.87-1.0) creating compressed, impactful text blocks.
...
```text
Create a concept visualization image for a presentation inspired by Composio.
Brand mood: Composio's interface is a nocturnal command center — a dense, developer-focused darkness punctuated by electric cyan and deep cobalt signals.
Use abcDiatype, with fallbacks: abcDiatype Fallback, ui-sans-serif, system-ui, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol, Noto Color Emoji as the display-type reference and JetBrains Mono, with fallbacks: JetBrains Mono Fallback, ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New for any short in-image labels.
Keep the palette anchored in Electric Cyan (#00ffff), Void Black (#0f0f0f), and Composio Cobalt (#0007cd).
Preserve these signature cues: Pitch-black canvas with near-invisible white-border containment (4-12% opacity), Dual-font identity: geometric sans-serif (abcDiatype) for content, monospace (JetBrains Mono) for technical credibility, and Ultra-tight heading line-heights (0.87-1.0) creating compressed, impactful text blocks.
...
```text
Create a comparison image for a presentation inspired by Composio.
Brand mood: Composio's interface is a nocturnal command center — a dense, developer-focused darkness punctuated by electric cyan and deep cobalt signals.
Use abcDiatype, with fallbacks: abcDiatype Fallback, ui-sans-serif, system-ui, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol, Noto Color Emoji as the display-type reference and JetBrains Mono, with fallbacks: JetBrains Mono Fallback, ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New for any short in-image labels.
Keep the palette anchored in Electric Cyan (#00ffff), Void Black (#0f0f0f), and Composio Cobalt (#0007cd).
Preserve these signature cues: Pitch-black canvas with near-invisible white-border containment (4-12% opacity), Dual-font identity: geometric sans-serif (abcDiatype) for content, monospace (JetBrains Mono) for technical credibility, and Ultra-tight heading line-heights (0.87-1.0) creating compressed, impactful text blocks.
...
```text
Create a data-support backdrop image for a presentation inspired by Composio.
Brand mood: Composio's interface is a nocturnal command center — a dense, developer-focused darkness punctuated by electric cyan and deep cobalt signals.
Use abcDiatype, with fallbacks: abcDiatype Fallback, ui-sans-serif, system-ui, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol, Noto Color Emoji as the display-type reference and JetBrains Mono, with fallbacks: JetBrains Mono Fallback, ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New for any short in-image labels.
Keep the palette anchored in Electric Cyan (#00ffff), Void Black (#0f0f0f), and Composio Cobalt (#0007cd).
Preserve these signature cues: Pitch-black canvas with near-invisible white-border containment (4-12% opacity), Dual-font identity: geometric sans-serif (abcDiatype) for content, monospace (JetBrains Mono) for technical credibility, and Ultra-tight heading line-heights (0.87-1.0) creating compressed, impactful text blocks.
...
```text
Create a closing poster image for a presentation inspired by Composio.
Brand mood: Composio's interface is a nocturnal command center — a dense, developer-focused darkness punctuated by electric cyan and deep cobalt signals.
Use abcDiatype, with fallbacks: abcDiatype Fallback, ui-sans-serif, system-ui, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol, Noto Color Emoji as the display-type reference and JetBrains Mono, with fallbacks: JetBrains Mono Fallback, ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New for any short in-image labels.
Keep the palette anchored in Electric Cyan (#00ffff), Void Black (#0f0f0f), and Composio Cobalt (#0007cd).
Preserve these signature cues: Pitch-black canvas with near-invisible white-border containment (4-12% opacity), Dual-font identity: geometric sans-serif (abcDiatype) for content, monospace (JetBrains Mono) for technical credibility, and Ultra-tight heading line-heights (0.87-1.0) creating compressed, impactful text blocks.
