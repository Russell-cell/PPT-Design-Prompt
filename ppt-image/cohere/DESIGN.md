# PPT-image Design System Inspired by Cohere

This file adapts the original web/UI-focused design system into a presentation-image system for slides.
Use it to generate cover art, chapter dividers, concept visuals, comparison plates, system diagrams, data backdrops, and closing posters that still feel unmistakably Cohere.

Source reference: `source/cohere/DESIGN.md`
Adaptation date: `2026-04-22`

## 1. Visual Theme & Atmosphere

This PPT-image adaptation keeps Cohere's brand DNA intact, but compresses it into slide-ready visuals instead of webpage UI.
The first priority is to preserve the original atmosphere: Cohere's interface is a polished enterprise command deck — confident, clean, and designed to make AI feel like serious infrastructure rather than a consumer toy.
...
- Preserve the brand's strongest cues: Bright white canvas with cool gray containment borders, 22px signature border-radius — the distinctive "Cohere card" roundness, Dual custom typeface: CohereText (display serif) + Unica77 (body sans), and Enterprise-grade chromatic restraint: black, white, cool grays, minimal purple-blue accent.
- Use Interaction Blue (#1863dc) as the highest-signal accent when color needs to carry emphasis.
- Let Pure White (#ffffff) carry calmer title-safe zones and quieter data-support slides.
- Use Deep Dark (#17171c) for cinematic divider slides, closing posters, or contrast-heavy cover moments.
...
- Bold contrast canvas: prefer Deep Dark (#17171c) when the deck needs cinematic weight or a chapter reset.
- Primary accent: Interaction Blue (#1863dc) should carry the strongest callout, hero focal area, or high-signal data accent.
...
- Use `CohereText, with fallbacks: Space Grotesk, Inter, ui-sans-serif, system-ui` as the reference voice for cover words, chapter titles, or one-line in-image headlines when baked text is necessary.
- Use `Unica77 Cohere Web, with fallbacks: Inter, Arial, ui-sans-serif, system-ui` for labels, short annotations, numerals, or tiny UI-like callouts inside the art.
...
- Use Cohere's strongest visual cues as one large, unmistakable scene or object.
- Let Interaction Blue (#1863dc), Pure White (#ffffff), and Deep Dark (#17171c) establish the hierarchy before adding any text.
...
- Translate abstract ideas into one visual metaphor that still feels native to Cohere.
...
- Let the palette do part of the comparison work: Pure White (#ffffff) versus Deep Dark (#17171c), with Interaction Blue (#1863dc) reserved for the decisive signal.
...
- Brand mood: Cohere's interface is a polished enterprise command deck — confident, clean, and designed to make AI feel like serious infrastructure rather than a consumer toy.
- Display voice: `CohereText, with fallbacks: Space Grotesk, Inter, ui-sans-serif, system-ui`
- Body / label voice: `Unica77 Cohere Web, with fallbacks: Inter, Arial, ui-sans-serif, system-ui`
- Primary accent: Interaction Blue (#1863dc)
- Light surface anchor: Pure White (#ffffff)
- Dark surface anchor: Deep Dark (#17171c)
- Signature cues: Bright white canvas with cool gray containment borders, 22px signature border-radius — the distinctive "Cohere card" roundness, Dual custom typeface: CohereText (display serif) + Unica77 (body sans), and Enterprise-grade chromatic restraint: black, white, cool grays, minimal purple-blue accent
...
```text
Create a presentation cover image for a presentation inspired by Cohere.
Brand mood: Cohere's interface is a polished enterprise command deck — confident, clean, and designed to make AI feel like serious infrastructure rather than a consumer toy.
Use CohereText, with fallbacks: Space Grotesk, Inter, ui-sans-serif, system-ui as the display-type reference and Unica77 Cohere Web, with fallbacks: Inter, Arial, ui-sans-serif, system-ui for any short in-image labels.
Keep the palette anchored in Pure White (#ffffff), Deep Dark (#17171c), and Interaction Blue (#1863dc).
Preserve these signature cues: Bright white canvas with cool gray containment borders, 22px signature border-radius — the distinctive "Cohere card" roundness, and Dual custom typeface: CohereText (display serif) + Unica77 (body sans).
...
```text
Create a section divider image for a presentation inspired by Cohere.
Brand mood: Cohere's interface is a polished enterprise command deck — confident, clean, and designed to make AI feel like serious infrastructure rather than a consumer toy.
Use CohereText, with fallbacks: Space Grotesk, Inter, ui-sans-serif, system-ui as the display-type reference and Unica77 Cohere Web, with fallbacks: Inter, Arial, ui-sans-serif, system-ui for any short in-image labels.
Keep the palette anchored in Pure White (#ffffff), Deep Dark (#17171c), and Interaction Blue (#1863dc).
Preserve these signature cues: Bright white canvas with cool gray containment borders, 22px signature border-radius — the distinctive "Cohere card" roundness, and Dual custom typeface: CohereText (display serif) + Unica77 (body sans).
...
```text
Create a concept visualization image for a presentation inspired by Cohere.
Brand mood: Cohere's interface is a polished enterprise command deck — confident, clean, and designed to make AI feel like serious infrastructure rather than a consumer toy.
Use CohereText, with fallbacks: Space Grotesk, Inter, ui-sans-serif, system-ui as the display-type reference and Unica77 Cohere Web, with fallbacks: Inter, Arial, ui-sans-serif, system-ui for any short in-image labels.
Keep the palette anchored in Pure White (#ffffff), Deep Dark (#17171c), and Interaction Blue (#1863dc).
Preserve these signature cues: Bright white canvas with cool gray containment borders, 22px signature border-radius — the distinctive "Cohere card" roundness, and Dual custom typeface: CohereText (display serif) + Unica77 (body sans).
...
```text
Create a comparison image for a presentation inspired by Cohere.
Brand mood: Cohere's interface is a polished enterprise command deck — confident, clean, and designed to make AI feel like serious infrastructure rather than a consumer toy.
Use CohereText, with fallbacks: Space Grotesk, Inter, ui-sans-serif, system-ui as the display-type reference and Unica77 Cohere Web, with fallbacks: Inter, Arial, ui-sans-serif, system-ui for any short in-image labels.
Keep the palette anchored in Pure White (#ffffff), Deep Dark (#17171c), and Interaction Blue (#1863dc).
Preserve these signature cues: Bright white canvas with cool gray containment borders, 22px signature border-radius — the distinctive "Cohere card" roundness, and Dual custom typeface: CohereText (display serif) + Unica77 (body sans).
...
```text
Create a data-support backdrop image for a presentation inspired by Cohere.
Brand mood: Cohere's interface is a polished enterprise command deck — confident, clean, and designed to make AI feel like serious infrastructure rather than a consumer toy.
Use CohereText, with fallbacks: Space Grotesk, Inter, ui-sans-serif, system-ui as the display-type reference and Unica77 Cohere Web, with fallbacks: Inter, Arial, ui-sans-serif, system-ui for any short in-image labels.
Keep the palette anchored in Pure White (#ffffff), Deep Dark (#17171c), and Interaction Blue (#1863dc).
Preserve these signature cues: Bright white canvas with cool gray containment borders, 22px signature border-radius — the distinctive "Cohere card" roundness, and Dual custom typeface: CohereText (display serif) + Unica77 (body sans).
...
```text
Create a closing poster image for a presentation inspired by Cohere.
Brand mood: Cohere's interface is a polished enterprise command deck — confident, clean, and designed to make AI feel like serious infrastructure rather than a consumer toy.
Use CohereText, with fallbacks: Space Grotesk, Inter, ui-sans-serif, system-ui as the display-type reference and Unica77 Cohere Web, with fallbacks: Inter, Arial, ui-sans-serif, system-ui for any short in-image labels.
Keep the palette anchored in Pure White (#ffffff), Deep Dark (#17171c), and Interaction Blue (#1863dc).
Preserve these signature cues: Bright white canvas with cool gray containment borders, 22px signature border-radius — the distinctive "Cohere card" roundness, and Dual custom typeface: CohereText (display serif) + Unica77 (body sans).
