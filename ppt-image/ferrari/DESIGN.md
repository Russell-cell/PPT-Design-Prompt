# PPT-image Design System Inspired by Ferrari

This file adapts the original web/UI-focused design system into a presentation-image system for slides.
Use it to generate cover art, chapter dividers, concept visuals, comparison plates, system diagrams, data backdrops, and closing posters that still feel unmistakably Ferrari.

Source reference: `source/ferrari/DESIGN.md`
Adaptation date: `2026-04-22`

## 1. Visual Theme & Atmosphere

This PPT-image adaptation keeps Ferrari's brand DNA intact, but compresses it into slide-ready visuals instead of webpage UI.
The first priority is to preserve the original atmosphere: Ferrari's website is a digital editorial — a curated magazine where the Prancing Horse brand is presented with the gravitas of an art institution and the precision of Italian coachwork.
...
- Preserve the brand's strongest cues: Chiaroscuro layout alternating between deep black sections and clean white editorial panels, Ferrari Red (#DA291C) used with extreme sparseness — accent, not atmosphere, Prancing Horse emblem as isolated hero element on a void-black field, and FerrariSans proprietary typeface with compact proportions and medium weights.
- Use Ferrari Red (#DA291C) as the highest-signal accent when color needs to carry emphasis.
- Let Pure White (#FFFFFF) carry calmer title-safe zones and quieter data-support slides.
- Use Absolute Black (#000000) for cinematic divider slides, closing posters, or contrast-heavy cover moments.
...
- Bold contrast canvas: prefer Absolute Black (#000000) when the deck needs cinematic weight or a chapter reset.
- Primary accent: Ferrari Red (#DA291C) should carry the strongest callout, hero focal area, or high-signal data accent.
...
- Use `Primary typeface for headings, navigation, buttons, and editorial content. A proprietary sans-serif with medium weight as the default (500), compact x-height, and precise letter-spacing control. Fallbacks: Arial, Helvetica, sans-serif` as the reference voice for cover words, chapter titles, or one-line in-image headlines when baked text is necessary.
- Use `Secondary typeface for captions, labels, and utility text. Frequently rendered in uppercase with expanded letter-spacing (1px) for an editorial label aesthetic. Used for category tags and small annotation text` for labels, short annotations, numerals, or tiny UI-like callouts inside the art.
...
- Use Ferrari's strongest visual cues as one large, unmistakable scene or object.
- Let Ferrari Red (#DA291C), Pure White (#FFFFFF), and Absolute Black (#000000) establish the hierarchy before adding any text.
...
- Translate abstract ideas into one visual metaphor that still feels native to Ferrari.
...
- Let the palette do part of the comparison work: Pure White (#FFFFFF) versus Absolute Black (#000000), with Ferrari Red (#DA291C) reserved for the decisive signal.
...
- Brand mood: Ferrari's website is a digital editorial — a curated magazine where the Prancing Horse brand is presented with the gravitas of an art institution and the precision of Italian coachwork.
- Display voice: `Primary typeface for headings, navigation, buttons, and editorial content. A proprietary sans-serif with medium weight as the default (500), compact x-height, and precise letter-spacing control. Fallbacks: Arial, Helvetica, sans-serif`
- Body / label voice: `Secondary typeface for captions, labels, and utility text. Frequently rendered in uppercase with expanded letter-spacing (1px) for an editorial label aesthetic. Used for category tags and small annotation text`
- Primary accent: Ferrari Red (#DA291C)
- Light surface anchor: Pure White (#FFFFFF)
- Dark surface anchor: Absolute Black (#000000)
- Signature cues: Chiaroscuro layout alternating between deep black sections and clean white editorial panels, Ferrari Red (#DA291C) used with extreme sparseness — accent, not atmosphere, Prancing Horse emblem as isolated hero element on a void-black field, and FerrariSans proprietary typeface with compact proportions and medium weights
...
```text
Create a presentation cover image for a presentation inspired by Ferrari.
Brand mood: Ferrari's website is a digital editorial — a curated magazine where the Prancing Horse brand is presented with the gravitas of an art institution and the precision of Italian coachwork.
Use Primary typeface for headings, navigation, buttons, and editorial content. A proprietary sans-serif with medium weight as the default (500), compact x-height, and precise letter-spacing control. Fallbacks: Arial, Helvetica, sans-serif as the display-type reference and Secondary typeface for captions, labels, and utility text. Frequently rendered in uppercase with expanded letter-spacing (1px) for an editorial label aesthetic. Used for category tags and small annotation text for any short in-image labels.
Keep the palette anchored in Pure White (#FFFFFF), Absolute Black (#000000), and Ferrari Red (#DA291C).
Preserve these signature cues: Chiaroscuro layout alternating between deep black sections and clean white editorial panels, Ferrari Red (#DA291C) used with extreme sparseness — accent, not atmosphere, and Prancing Horse emblem as isolated hero element on a void-black field.
...
```text
Create a section divider image for a presentation inspired by Ferrari.
Brand mood: Ferrari's website is a digital editorial — a curated magazine where the Prancing Horse brand is presented with the gravitas of an art institution and the precision of Italian coachwork.
Use Primary typeface for headings, navigation, buttons, and editorial content. A proprietary sans-serif with medium weight as the default (500), compact x-height, and precise letter-spacing control. Fallbacks: Arial, Helvetica, sans-serif as the display-type reference and Secondary typeface for captions, labels, and utility text. Frequently rendered in uppercase with expanded letter-spacing (1px) for an editorial label aesthetic. Used for category tags and small annotation text for any short in-image labels.
Keep the palette anchored in Pure White (#FFFFFF), Absolute Black (#000000), and Ferrari Red (#DA291C).
Preserve these signature cues: Chiaroscuro layout alternating between deep black sections and clean white editorial panels, Ferrari Red (#DA291C) used with extreme sparseness — accent, not atmosphere, and Prancing Horse emblem as isolated hero element on a void-black field.
...
```text
Create a concept visualization image for a presentation inspired by Ferrari.
Brand mood: Ferrari's website is a digital editorial — a curated magazine where the Prancing Horse brand is presented with the gravitas of an art institution and the precision of Italian coachwork.
Use Primary typeface for headings, navigation, buttons, and editorial content. A proprietary sans-serif with medium weight as the default (500), compact x-height, and precise letter-spacing control. Fallbacks: Arial, Helvetica, sans-serif as the display-type reference and Secondary typeface for captions, labels, and utility text. Frequently rendered in uppercase with expanded letter-spacing (1px) for an editorial label aesthetic. Used for category tags and small annotation text for any short in-image labels.
Keep the palette anchored in Pure White (#FFFFFF), Absolute Black (#000000), and Ferrari Red (#DA291C).
Preserve these signature cues: Chiaroscuro layout alternating between deep black sections and clean white editorial panels, Ferrari Red (#DA291C) used with extreme sparseness — accent, not atmosphere, and Prancing Horse emblem as isolated hero element on a void-black field.
...
```text
Create a comparison image for a presentation inspired by Ferrari.
Brand mood: Ferrari's website is a digital editorial — a curated magazine where the Prancing Horse brand is presented with the gravitas of an art institution and the precision of Italian coachwork.
Use Primary typeface for headings, navigation, buttons, and editorial content. A proprietary sans-serif with medium weight as the default (500), compact x-height, and precise letter-spacing control. Fallbacks: Arial, Helvetica, sans-serif as the display-type reference and Secondary typeface for captions, labels, and utility text. Frequently rendered in uppercase with expanded letter-spacing (1px) for an editorial label aesthetic. Used for category tags and small annotation text for any short in-image labels.
Keep the palette anchored in Pure White (#FFFFFF), Absolute Black (#000000), and Ferrari Red (#DA291C).
Preserve these signature cues: Chiaroscuro layout alternating between deep black sections and clean white editorial panels, Ferrari Red (#DA291C) used with extreme sparseness — accent, not atmosphere, and Prancing Horse emblem as isolated hero element on a void-black field.
...
```text
Create a data-support backdrop image for a presentation inspired by Ferrari.
Brand mood: Ferrari's website is a digital editorial — a curated magazine where the Prancing Horse brand is presented with the gravitas of an art institution and the precision of Italian coachwork.
Use Primary typeface for headings, navigation, buttons, and editorial content. A proprietary sans-serif with medium weight as the default (500), compact x-height, and precise letter-spacing control. Fallbacks: Arial, Helvetica, sans-serif as the display-type reference and Secondary typeface for captions, labels, and utility text. Frequently rendered in uppercase with expanded letter-spacing (1px) for an editorial label aesthetic. Used for category tags and small annotation text for any short in-image labels.
Keep the palette anchored in Pure White (#FFFFFF), Absolute Black (#000000), and Ferrari Red (#DA291C).
Preserve these signature cues: Chiaroscuro layout alternating between deep black sections and clean white editorial panels, Ferrari Red (#DA291C) used with extreme sparseness — accent, not atmosphere, and Prancing Horse emblem as isolated hero element on a void-black field.
...
```text
Create a closing poster image for a presentation inspired by Ferrari.
Brand mood: Ferrari's website is a digital editorial — a curated magazine where the Prancing Horse brand is presented with the gravitas of an art institution and the precision of Italian coachwork.
Use Primary typeface for headings, navigation, buttons, and editorial content. A proprietary sans-serif with medium weight as the default (500), compact x-height, and precise letter-spacing control. Fallbacks: Arial, Helvetica, sans-serif as the display-type reference and Secondary typeface for captions, labels, and utility text. Frequently rendered in uppercase with expanded letter-spacing (1px) for an editorial label aesthetic. Used for category tags and small annotation text for any short in-image labels.
Keep the palette anchored in Pure White (#FFFFFF), Absolute Black (#000000), and Ferrari Red (#DA291C).
Preserve these signature cues: Chiaroscuro layout alternating between deep black sections and clean white editorial panels, Ferrari Red (#DA291C) used with extreme sparseness — accent, not atmosphere, and Prancing Horse emblem as isolated hero element on a void-black field.
