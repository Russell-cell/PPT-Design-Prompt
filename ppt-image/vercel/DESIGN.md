# PPT-image Design System Inspired by Vercel

This file adapts the original web/UI-focused design system into a presentation-image system for slides.
Use it to generate cover art, chapter dividers, concept visuals, comparison plates, system diagrams, data backdrops, and closing posters that still feel unmistakably Vercel.

Source reference: `source/vercel/DESIGN.md`
Adaptation date: `2026-04-22`

## 1. Visual Theme & Atmosphere

This PPT-image adaptation keeps Vercel's brand DNA intact, but compresses it into slide-ready visuals instead of webpage UI.
The first priority is to preserve the original atmosphere: Vercel's website is the visual thesis of developer infrastructure made invisible — a design system so restrained it borders on philosophical.
...
- Preserve the brand's strongest cues: Geist Sans with extreme negative letter-spacing (-2.4px to -2.88px at display) — text as compressed infrastructure, Geist Mono for code and technical labels with OpenType "liga" globally, Shadow-as-border technique: box-shadow 0px 0px 0px 1px replaces traditional borders throughout, and Multi-layer shadow stacks for nuanced depth (border + elevation + ambient in single declarations).
- Use Link Blue (#0072f5) as the highest-signal accent when color needs to carry emphasis.
- Let Vercel Black (#171717) carry calmer title-safe zones and quieter data-support slides.
- Use Vercel Black (#171717) for cinematic divider slides, closing posters, or contrast-heavy cover moments.
...
- Base canvas: prefer Vercel Black (#171717) when the deck needs editorial calm or readable overlay copy.
- Bold contrast canvas: prefer Vercel Black (#171717) when the deck needs cinematic weight or a chapter reset.
- Primary accent: Link Blue (#0072f5) should carry the strongest callout, hero focal area, or high-signal data accent.
...
- Use `Geist, with fallbacks: Arial, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol` as the reference voice for cover words, chapter titles, or one-line in-image headlines when baked text is necessary.
- Use `Geist Mono, with fallbacks: ui-monospace, SFMono-Regular, Roboto Mono, Menlo, Monaco, Liberation Mono, DejaVu Sans Mono, Courier New` for labels, short annotations, numerals, or tiny UI-like callouts inside the art.
...
- Use Vercel's strongest visual cues as one large, unmistakable scene or object.
- Let Link Blue (#0072f5), Vercel Black (#171717), and Vercel Black (#171717) establish the hierarchy before adding any text.
...
- Translate abstract ideas into one visual metaphor that still feels native to Vercel.
...
- Let the palette do part of the comparison work: Vercel Black (#171717) versus Vercel Black (#171717), with Link Blue (#0072f5) reserved for the decisive signal.
...
- Brand mood: Vercel's website is the visual thesis of developer infrastructure made invisible — a design system so restrained it borders on philosophical.
- Display voice: `Geist, with fallbacks: Arial, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol`
- Body / label voice: `Geist Mono, with fallbacks: ui-monospace, SFMono-Regular, Roboto Mono, Menlo, Monaco, Liberation Mono, DejaVu Sans Mono, Courier New`
- Primary accent: Link Blue (#0072f5)
- Light surface anchor: Vercel Black (#171717)
- Dark surface anchor: Vercel Black (#171717)
- Signature cues: Geist Sans with extreme negative letter-spacing (-2.4px to -2.88px at display) — text as compressed infrastructure, Geist Mono for code and technical labels with OpenType "liga" globally, Shadow-as-border technique: box-shadow 0px 0px 0px 1px replaces traditional borders throughout, and Multi-layer shadow stacks for nuanced depth (border + elevation + ambient in single declarations)
...
```text
Create a presentation cover image for a presentation inspired by Vercel.
Brand mood: Vercel's website is the visual thesis of developer infrastructure made invisible — a design system so restrained it borders on philosophical.
Use Geist, with fallbacks: Arial, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol as the display-type reference and Geist Mono, with fallbacks: ui-monospace, SFMono-Regular, Roboto Mono, Menlo, Monaco, Liberation Mono, DejaVu Sans Mono, Courier New for any short in-image labels.
Keep the palette anchored in Vercel Black (#171717), Vercel Black (#171717), and Link Blue (#0072f5).
Preserve these signature cues: Geist Sans with extreme negative letter-spacing (-2.4px to -2.88px at display) — text as compressed infrastructure, Geist Mono for code and technical labels with OpenType "liga" globally, and Shadow-as-border technique: box-shadow 0px 0px 0px 1px replaces traditional borders throughout.
...
```text
Create a section divider image for a presentation inspired by Vercel.
Brand mood: Vercel's website is the visual thesis of developer infrastructure made invisible — a design system so restrained it borders on philosophical.
Use Geist, with fallbacks: Arial, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol as the display-type reference and Geist Mono, with fallbacks: ui-monospace, SFMono-Regular, Roboto Mono, Menlo, Monaco, Liberation Mono, DejaVu Sans Mono, Courier New for any short in-image labels.
Keep the palette anchored in Vercel Black (#171717), Vercel Black (#171717), and Link Blue (#0072f5).
Preserve these signature cues: Geist Sans with extreme negative letter-spacing (-2.4px to -2.88px at display) — text as compressed infrastructure, Geist Mono for code and technical labels with OpenType "liga" globally, and Shadow-as-border technique: box-shadow 0px 0px 0px 1px replaces traditional borders throughout.
...
```text
Create a concept visualization image for a presentation inspired by Vercel.
Brand mood: Vercel's website is the visual thesis of developer infrastructure made invisible — a design system so restrained it borders on philosophical.
Use Geist, with fallbacks: Arial, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol as the display-type reference and Geist Mono, with fallbacks: ui-monospace, SFMono-Regular, Roboto Mono, Menlo, Monaco, Liberation Mono, DejaVu Sans Mono, Courier New for any short in-image labels.
Keep the palette anchored in Vercel Black (#171717), Vercel Black (#171717), and Link Blue (#0072f5).
Preserve these signature cues: Geist Sans with extreme negative letter-spacing (-2.4px to -2.88px at display) — text as compressed infrastructure, Geist Mono for code and technical labels with OpenType "liga" globally, and Shadow-as-border technique: box-shadow 0px 0px 0px 1px replaces traditional borders throughout.
...
```text
Create a comparison image for a presentation inspired by Vercel.
Brand mood: Vercel's website is the visual thesis of developer infrastructure made invisible — a design system so restrained it borders on philosophical.
Use Geist, with fallbacks: Arial, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol as the display-type reference and Geist Mono, with fallbacks: ui-monospace, SFMono-Regular, Roboto Mono, Menlo, Monaco, Liberation Mono, DejaVu Sans Mono, Courier New for any short in-image labels.
Keep the palette anchored in Vercel Black (#171717), Vercel Black (#171717), and Link Blue (#0072f5).
Preserve these signature cues: Geist Sans with extreme negative letter-spacing (-2.4px to -2.88px at display) — text as compressed infrastructure, Geist Mono for code and technical labels with OpenType "liga" globally, and Shadow-as-border technique: box-shadow 0px 0px 0px 1px replaces traditional borders throughout.
...
```text
Create a data-support backdrop image for a presentation inspired by Vercel.
Brand mood: Vercel's website is the visual thesis of developer infrastructure made invisible — a design system so restrained it borders on philosophical.
Use Geist, with fallbacks: Arial, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol as the display-type reference and Geist Mono, with fallbacks: ui-monospace, SFMono-Regular, Roboto Mono, Menlo, Monaco, Liberation Mono, DejaVu Sans Mono, Courier New for any short in-image labels.
Keep the palette anchored in Vercel Black (#171717), Vercel Black (#171717), and Link Blue (#0072f5).
Preserve these signature cues: Geist Sans with extreme negative letter-spacing (-2.4px to -2.88px at display) — text as compressed infrastructure, Geist Mono for code and technical labels with OpenType "liga" globally, and Shadow-as-border technique: box-shadow 0px 0px 0px 1px replaces traditional borders throughout.
...
```text
Create a closing poster image for a presentation inspired by Vercel.
Brand mood: Vercel's website is the visual thesis of developer infrastructure made invisible — a design system so restrained it borders on philosophical.
Use Geist, with fallbacks: Arial, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol as the display-type reference and Geist Mono, with fallbacks: ui-monospace, SFMono-Regular, Roboto Mono, Menlo, Monaco, Liberation Mono, DejaVu Sans Mono, Courier New for any short in-image labels.
Keep the palette anchored in Vercel Black (#171717), Vercel Black (#171717), and Link Blue (#0072f5).
Preserve these signature cues: Geist Sans with extreme negative letter-spacing (-2.4px to -2.88px at display) — text as compressed infrastructure, Geist Mono for code and technical labels with OpenType "liga" globally, and Shadow-as-border technique: box-shadow 0px 0px 0px 1px replaces traditional borders throughout.
