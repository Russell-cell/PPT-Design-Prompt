# PPT-image Design System Inspired by Spotify

This file adapts the original web/UI-focused design system into a presentation-image system for slides.
Use it to generate cover art, chapter dividers, concept visuals, comparison plates, system diagrams, data backdrops, and closing posters that still feel unmistakably Spotify.

Source reference: `source/spotify/DESIGN.md`
Adaptation date: `2026-04-22`

## 1. Visual Theme & Atmosphere

This PPT-image adaptation keeps Spotify's brand DNA intact, but compresses it into slide-ready visuals instead of webpage UI.
The first priority is to preserve the original atmosphere: Spotify's web interface is a dark, immersive music player that wraps listeners in a near-black cocoon (#121212, #181818, #1f1f1f) where album art and content become the primary source of color.
...
- Preserve the brand's strongest cues: Near-black immersive dark theme (#121212–#1f1f1f) — UI disappears behind content, Spotify Green (#1ed760) as singular brand accent — never decorative, always functional, SpotifyMixUI/CircularSp font family with global script support, and Pill buttons (500px–9999px) and circular controls (50%) — rounded, touch-optimized.
- Use Spotify Green (#1ed760) as the highest-signal accent when color needs to carry emphasis.
- Let Near White (#cbcbcb) carry calmer title-safe zones and quieter data-support slides.
- Use Near Black (#121212) for cinematic divider slides, closing posters, or contrast-heavy cover moments.
...
- Base canvas: prefer Near White (#cbcbcb) when the deck needs editorial calm or readable overlay copy.
- Bold contrast canvas: prefer Near Black (#121212) when the deck needs cinematic weight or a chapter reset.
- Primary accent: Spotify Green (#1ed760) should carry the strongest callout, hero focal area, or high-signal data accent.
...
- Use `SpotifyMixUITitle, fallbacks: CircularSp-Arab, CircularSp-Hebr, CircularSp-Cyrl, CircularSp-Grek, CircularSp-Deva, Helvetica Neue, helvetica, arial, Hiragino Sans, Hiragino Kaku Gothic ProN, Meiryo, MS Gothic` as the reference voice for cover words, chapter titles, or one-line in-image headlines when baked text is necessary.
- Use `SpotifyMixUI, same fallback stack` for labels, short annotations, numerals, or tiny UI-like callouts inside the art.
...
- Use Spotify's strongest visual cues as one large, unmistakable scene or object.
- Let Spotify Green (#1ed760), Near White (#cbcbcb), and Near Black (#121212) establish the hierarchy before adding any text.
...
- Translate abstract ideas into one visual metaphor that still feels native to Spotify.
...
- Let the palette do part of the comparison work: Near White (#cbcbcb) versus Near Black (#121212), with Spotify Green (#1ed760) reserved for the decisive signal.
...
- Brand mood: Spotify's web interface is a dark, immersive music player that wraps listeners in a near-black cocoon (#121212, #181818, #1f1f1f) where album art and content become the primary source of color.
- Display voice: `SpotifyMixUITitle, fallbacks: CircularSp-Arab, CircularSp-Hebr, CircularSp-Cyrl, CircularSp-Grek, CircularSp-Deva, Helvetica Neue, helvetica, arial, Hiragino Sans, Hiragino Kaku Gothic ProN, Meiryo, MS Gothic`
- Body / label voice: `SpotifyMixUI, same fallback stack`
- Primary accent: Spotify Green (#1ed760)
- Light surface anchor: Near White (#cbcbcb)
- Dark surface anchor: Near Black (#121212)
- Signature cues: Near-black immersive dark theme (#121212–#1f1f1f) — UI disappears behind content, Spotify Green (#1ed760) as singular brand accent — never decorative, always functional, SpotifyMixUI/CircularSp font family with global script support, and Pill buttons (500px–9999px) and circular controls (50%) — rounded, touch-optimized
...
```text
Create a presentation cover image for a presentation inspired by Spotify.
Brand mood: Spotify's web interface is a dark, immersive music player that wraps listeners in a near-black cocoon (#121212, #181818, #1f1f1f) where album art and content become the primary source of color.
Use SpotifyMixUITitle, fallbacks: CircularSp-Arab, CircularSp-Hebr, CircularSp-Cyrl, CircularSp-Grek, CircularSp-Deva, Helvetica Neue, helvetica, arial, Hiragino Sans, Hiragino Kaku Gothic ProN, Meiryo, MS Gothic as the display-type reference and SpotifyMixUI, same fallback stack for any short in-image labels.
Keep the palette anchored in Near White (#cbcbcb), Near Black (#121212), and Spotify Green (#1ed760).
Preserve these signature cues: Near-black immersive dark theme (#121212–#1f1f1f) — UI disappears behind content, Spotify Green (#1ed760) as singular brand accent — never decorative, always functional, and SpotifyMixUI/CircularSp font family with global script support.
...
```text
Create a section divider image for a presentation inspired by Spotify.
Brand mood: Spotify's web interface is a dark, immersive music player that wraps listeners in a near-black cocoon (#121212, #181818, #1f1f1f) where album art and content become the primary source of color.
Use SpotifyMixUITitle, fallbacks: CircularSp-Arab, CircularSp-Hebr, CircularSp-Cyrl, CircularSp-Grek, CircularSp-Deva, Helvetica Neue, helvetica, arial, Hiragino Sans, Hiragino Kaku Gothic ProN, Meiryo, MS Gothic as the display-type reference and SpotifyMixUI, same fallback stack for any short in-image labels.
Keep the palette anchored in Near White (#cbcbcb), Near Black (#121212), and Spotify Green (#1ed760).
Preserve these signature cues: Near-black immersive dark theme (#121212–#1f1f1f) — UI disappears behind content, Spotify Green (#1ed760) as singular brand accent — never decorative, always functional, and SpotifyMixUI/CircularSp font family with global script support.
...
```text
Create a concept visualization image for a presentation inspired by Spotify.
Brand mood: Spotify's web interface is a dark, immersive music player that wraps listeners in a near-black cocoon (#121212, #181818, #1f1f1f) where album art and content become the primary source of color.
Use SpotifyMixUITitle, fallbacks: CircularSp-Arab, CircularSp-Hebr, CircularSp-Cyrl, CircularSp-Grek, CircularSp-Deva, Helvetica Neue, helvetica, arial, Hiragino Sans, Hiragino Kaku Gothic ProN, Meiryo, MS Gothic as the display-type reference and SpotifyMixUI, same fallback stack for any short in-image labels.
Keep the palette anchored in Near White (#cbcbcb), Near Black (#121212), and Spotify Green (#1ed760).
Preserve these signature cues: Near-black immersive dark theme (#121212–#1f1f1f) — UI disappears behind content, Spotify Green (#1ed760) as singular brand accent — never decorative, always functional, and SpotifyMixUI/CircularSp font family with global script support.
...
```text
Create a comparison image for a presentation inspired by Spotify.
Brand mood: Spotify's web interface is a dark, immersive music player that wraps listeners in a near-black cocoon (#121212, #181818, #1f1f1f) where album art and content become the primary source of color.
Use SpotifyMixUITitle, fallbacks: CircularSp-Arab, CircularSp-Hebr, CircularSp-Cyrl, CircularSp-Grek, CircularSp-Deva, Helvetica Neue, helvetica, arial, Hiragino Sans, Hiragino Kaku Gothic ProN, Meiryo, MS Gothic as the display-type reference and SpotifyMixUI, same fallback stack for any short in-image labels.
Keep the palette anchored in Near White (#cbcbcb), Near Black (#121212), and Spotify Green (#1ed760).
Preserve these signature cues: Near-black immersive dark theme (#121212–#1f1f1f) — UI disappears behind content, Spotify Green (#1ed760) as singular brand accent — never decorative, always functional, and SpotifyMixUI/CircularSp font family with global script support.
...
```text
Create a data-support backdrop image for a presentation inspired by Spotify.
Brand mood: Spotify's web interface is a dark, immersive music player that wraps listeners in a near-black cocoon (#121212, #181818, #1f1f1f) where album art and content become the primary source of color.
Use SpotifyMixUITitle, fallbacks: CircularSp-Arab, CircularSp-Hebr, CircularSp-Cyrl, CircularSp-Grek, CircularSp-Deva, Helvetica Neue, helvetica, arial, Hiragino Sans, Hiragino Kaku Gothic ProN, Meiryo, MS Gothic as the display-type reference and SpotifyMixUI, same fallback stack for any short in-image labels.
Keep the palette anchored in Near White (#cbcbcb), Near Black (#121212), and Spotify Green (#1ed760).
Preserve these signature cues: Near-black immersive dark theme (#121212–#1f1f1f) — UI disappears behind content, Spotify Green (#1ed760) as singular brand accent — never decorative, always functional, and SpotifyMixUI/CircularSp font family with global script support.
...
```text
Create a closing poster image for a presentation inspired by Spotify.
Brand mood: Spotify's web interface is a dark, immersive music player that wraps listeners in a near-black cocoon (#121212, #181818, #1f1f1f) where album art and content become the primary source of color.
Use SpotifyMixUITitle, fallbacks: CircularSp-Arab, CircularSp-Hebr, CircularSp-Cyrl, CircularSp-Grek, CircularSp-Deva, Helvetica Neue, helvetica, arial, Hiragino Sans, Hiragino Kaku Gothic ProN, Meiryo, MS Gothic as the display-type reference and SpotifyMixUI, same fallback stack for any short in-image labels.
Keep the palette anchored in Near White (#cbcbcb), Near Black (#121212), and Spotify Green (#1ed760).
Preserve these signature cues: Near-black immersive dark theme (#121212–#1f1f1f) — UI disappears behind content, Spotify Green (#1ed760) as singular brand accent — never decorative, always functional, and SpotifyMixUI/CircularSp font family with global script support.
