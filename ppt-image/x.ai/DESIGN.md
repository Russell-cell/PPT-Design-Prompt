# PPT-image Design System Inspired by xAI

This file adapts the original web/UI-focused design system into a presentation-image system for slides.
Use it to generate cover art, chapter dividers, concept visuals, comparison plates, system diagrams, data backdrops, and closing posters that still feel unmistakably xAI.

Source reference: `source/x.ai/DESIGN.md`
Adaptation date: `2026-04-22`

## 1. Visual Theme & Atmosphere

This PPT-image adaptation keeps xAI's brand DNA intact, but compresses it into slide-ready visuals instead of webpage UI.
The first priority is to preserve the original atmosphere: xAI's website is a masterclass in dark-first, monospace-driven brutalist minimalism -- a design system that feels like it was built by engineers who understand that restraint is the ultimate form of sophistication.
...
- Preserve the brand's strongest cues: Pure dark theme: #1f2228 background with #ffffff text -- no gray middle ground, GeistMono at extreme display sizes (320px, weight 300) -- monospace as luxury, Uppercase monospace buttons with 1.4px letter-spacing -- technical, commanding, and universalSans for body text at 16px/1.5 and headings at 30px/1.2 -- clean contrast.
- Use Ring Blue (rgb(59, 130, 246) / 0.5) as the highest-signal accent when color needs to carry emphasis.
- Let White Subtle (rgba(255, 255, 255, 0.2)) carry calmer title-safe zones and quieter data-support slides.
- Use Dark Background (#1f2228) for cinematic divider slides, closing posters, or contrast-heavy cover moments.
...
- Base canvas: prefer White Subtle (rgba(255, 255, 255, 0.2)) when the deck needs editorial calm or readable overlay copy.
- Bold contrast canvas: prefer Dark Background (#1f2228) when the deck needs cinematic weight or a chapter reset.
- Primary accent: Ring Blue (rgb(59, 130, 246) / 0.5) should carry the strongest callout, hero focal area, or high-signal data accent.
...
- Use `GeistMono / fallback: ui-monospace, SFMono-Regular, Roboto Mono, Menlo, Monaco, Liberation Mono, DejaVu Sans Mono, Courier New` as the reference voice for cover words, chapter titles, or one-line in-image headlines when baked text is necessary.
- Use `universalSans / fallback: universalSans Fallback` for labels, short annotations, numerals, or tiny UI-like callouts inside the art.
...
- Use xAI's strongest visual cues as one large, unmistakable scene or object.
- Let Ring Blue (rgb(59, 130, 246) / 0.5), White Subtle (rgba(255, 255, 255, 0.2)), and Dark Background (#1f2228) establish the hierarchy before adding any text.
- Pull attitude from Buttons, Cards & Containers, Navigation, and Badges / Tags rather than recreating literal buttons, nav bars, or forms.
...
- Translate abstract ideas into one visual metaphor that still feels native to xAI.
...
- Let the palette do part of the comparison work: White Subtle (rgba(255, 255, 255, 0.2)) versus Dark Background (#1f2228), with Ring Blue (rgb(59, 130, 246) / 0.5) reserved for the decisive signal.
...
- Brand mood: xAI's website is a masterclass in dark-first, monospace-driven brutalist minimalism -- a design system that feels like it was built by engineers who understand that restraint is the ultimate form of sophistication.
- Display voice: `GeistMono / fallback: ui-monospace, SFMono-Regular, Roboto Mono, Menlo, Monaco, Liberation Mono, DejaVu Sans Mono, Courier New`
- Body / label voice: `universalSans / fallback: universalSans Fallback`
- Primary accent: Ring Blue (rgb(59, 130, 246) / 0.5)
- Light surface anchor: White Subtle (rgba(255, 255, 255, 0.2))
- Dark surface anchor: Dark Background (#1f2228)
- Signature cues: Pure dark theme: #1f2228 background with #ffffff text -- no gray middle ground, GeistMono at extreme display sizes (320px, weight 300) -- monospace as luxury, Uppercase monospace buttons with 1.4px letter-spacing -- technical, commanding, and universalSans for body text at 16px/1.5 and headings at 30px/1.2 -- clean contrast
...
```text
Create a presentation cover image for a presentation inspired by xAI.
Brand mood: xAI's website is a masterclass in dark-first, monospace-driven brutalist minimalism -- a design system that feels like it was built by engineers who understand that restraint is the ultimate form of sophistication.
Use GeistMono / fallback: ui-monospace, SFMono-Regular, Roboto Mono, Menlo, Monaco, Liberation Mono, DejaVu Sans Mono, Courier New as the display-type reference and universalSans / fallback: universalSans Fallback for any short in-image labels.
Keep the palette anchored in White Subtle (rgba(255, 255, 255, 0.2)), Dark Background (#1f2228), and Ring Blue (rgb(59, 130, 246) / 0.5).
Preserve these signature cues: Pure dark theme: #1f2228 background with #ffffff text -- no gray middle ground, GeistMono at extreme display sizes (320px, weight 300) -- monospace as luxury, and Uppercase monospace buttons with 1.4px letter-spacing -- technical, commanding.
...
```text
Create a section divider image for a presentation inspired by xAI.
Brand mood: xAI's website is a masterclass in dark-first, monospace-driven brutalist minimalism -- a design system that feels like it was built by engineers who understand that restraint is the ultimate form of sophistication.
Use GeistMono / fallback: ui-monospace, SFMono-Regular, Roboto Mono, Menlo, Monaco, Liberation Mono, DejaVu Sans Mono, Courier New as the display-type reference and universalSans / fallback: universalSans Fallback for any short in-image labels.
Keep the palette anchored in White Subtle (rgba(255, 255, 255, 0.2)), Dark Background (#1f2228), and Ring Blue (rgb(59, 130, 246) / 0.5).
Preserve these signature cues: Pure dark theme: #1f2228 background with #ffffff text -- no gray middle ground, GeistMono at extreme display sizes (320px, weight 300) -- monospace as luxury, and Uppercase monospace buttons with 1.4px letter-spacing -- technical, commanding.
...
```text
Create a concept visualization image for a presentation inspired by xAI.
Brand mood: xAI's website is a masterclass in dark-first, monospace-driven brutalist minimalism -- a design system that feels like it was built by engineers who understand that restraint is the ultimate form of sophistication.
Use GeistMono / fallback: ui-monospace, SFMono-Regular, Roboto Mono, Menlo, Monaco, Liberation Mono, DejaVu Sans Mono, Courier New as the display-type reference and universalSans / fallback: universalSans Fallback for any short in-image labels.
Keep the palette anchored in White Subtle (rgba(255, 255, 255, 0.2)), Dark Background (#1f2228), and Ring Blue (rgb(59, 130, 246) / 0.5).
Preserve these signature cues: Pure dark theme: #1f2228 background with #ffffff text -- no gray middle ground, GeistMono at extreme display sizes (320px, weight 300) -- monospace as luxury, and Uppercase monospace buttons with 1.4px letter-spacing -- technical, commanding.
...
```text
Create a comparison image for a presentation inspired by xAI.
Brand mood: xAI's website is a masterclass in dark-first, monospace-driven brutalist minimalism -- a design system that feels like it was built by engineers who understand that restraint is the ultimate form of sophistication.
Use GeistMono / fallback: ui-monospace, SFMono-Regular, Roboto Mono, Menlo, Monaco, Liberation Mono, DejaVu Sans Mono, Courier New as the display-type reference and universalSans / fallback: universalSans Fallback for any short in-image labels.
Keep the palette anchored in White Subtle (rgba(255, 255, 255, 0.2)), Dark Background (#1f2228), and Ring Blue (rgb(59, 130, 246) / 0.5).
Preserve these signature cues: Pure dark theme: #1f2228 background with #ffffff text -- no gray middle ground, GeistMono at extreme display sizes (320px, weight 300) -- monospace as luxury, and Uppercase monospace buttons with 1.4px letter-spacing -- technical, commanding.
...
```text
Create a data-support backdrop image for a presentation inspired by xAI.
Brand mood: xAI's website is a masterclass in dark-first, monospace-driven brutalist minimalism -- a design system that feels like it was built by engineers who understand that restraint is the ultimate form of sophistication.
Use GeistMono / fallback: ui-monospace, SFMono-Regular, Roboto Mono, Menlo, Monaco, Liberation Mono, DejaVu Sans Mono, Courier New as the display-type reference and universalSans / fallback: universalSans Fallback for any short in-image labels.
Keep the palette anchored in White Subtle (rgba(255, 255, 255, 0.2)), Dark Background (#1f2228), and Ring Blue (rgb(59, 130, 246) / 0.5).
Preserve these signature cues: Pure dark theme: #1f2228 background with #ffffff text -- no gray middle ground, GeistMono at extreme display sizes (320px, weight 300) -- monospace as luxury, and Uppercase monospace buttons with 1.4px letter-spacing -- technical, commanding.
...
```text
Create a closing poster image for a presentation inspired by xAI.
Brand mood: xAI's website is a masterclass in dark-first, monospace-driven brutalist minimalism -- a design system that feels like it was built by engineers who understand that restraint is the ultimate form of sophistication.
Use GeistMono / fallback: ui-monospace, SFMono-Regular, Roboto Mono, Menlo, Monaco, Liberation Mono, DejaVu Sans Mono, Courier New as the display-type reference and universalSans / fallback: universalSans Fallback for any short in-image labels.
Keep the palette anchored in White Subtle (rgba(255, 255, 255, 0.2)), Dark Background (#1f2228), and Ring Blue (rgb(59, 130, 246) / 0.5).
Preserve these signature cues: Pure dark theme: #1f2228 background with #ffffff text -- no gray middle ground, GeistMono at extreme display sizes (320px, weight 300) -- monospace as luxury, and Uppercase monospace buttons with 1.4px letter-spacing -- technical, commanding.
